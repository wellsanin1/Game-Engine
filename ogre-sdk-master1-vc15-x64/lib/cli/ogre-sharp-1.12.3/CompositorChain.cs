...
public class CompositorChain : RenderTargetListener {
  ...
  public SWIGTYPE_p_std__vectorT_Ogre__CompositorInstance_p_t getCompositorInstances() {
    SWIGTYPE_p_std__vectorT_Ogre__CompositorInstance_p_t ret = new SWIGTYPE_p_std__vectorT_Ogre__CompositorInstance_p_t(OgrePINVOKE.CompositorChain_getCompositorInstances(swigCPtr), false);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
