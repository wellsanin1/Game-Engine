...
public class LightFactory : MovableObjectFactory {
  ...
  public override void Dispose() {
    lock(this) {
      if (swigCPtr.Handle != global::System.IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          OgrePINVOKE.delete_LightFactory(swigCPtr);
        }
  ...
  public static string FACTORY_TYPE_NAME {
    set {
      OgrePINVOKE.LightFactory_FACTORY_TYPE_NAME_set(value);
      if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    } 
    get {
      string ret = OgrePINVOKE.LightFactory_FACTORY_TYPE_NAME_get();
      if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
      return ret;
    } 
  }
  ...
  public override string getType() {
    string ret = OgrePINVOKE.LightFactory_getType(swigCPtr);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public override void destroyInstance(MovableObject obj) {
    OgrePINVOKE.LightFactory_destroyInstance(swigCPtr, MovableObject.getCPtr(obj));
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }
