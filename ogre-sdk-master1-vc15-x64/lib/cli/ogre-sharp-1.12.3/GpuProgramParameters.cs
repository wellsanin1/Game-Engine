...
public class GpuProgramParameters : global::System.IDisposable {
  ...
  public class AutoConstantDefinition : global::System.IDisposable {
    ...
    public GpuProgramParameters.ElementType elementType {
      set {
        OgrePINVOKE.GpuProgramParameters_AutoConstantDefinition_elementType_set(swigCPtr, (int)value);
        if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
      } 
      get {
        GpuProgramParameters.ElementType ret = (GpuProgramParameters.ElementType)OgrePINVOKE.GpuProgramParameters_AutoConstantDefinition_elementType_get(swigCPtr);
        if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
        return ret;
      } 
    }
    ...
    public AutoConstantDefinition(GpuProgramParameters.AutoConstantType _acType, string _name, uint _elementCount, GpuProgramParameters.ElementType _elementType, GpuProgramParameters.ACDataType _dataType) : this(OgrePINVOKE.new_GpuProgramParameters_AutoConstantDefinition((int)_acType, _name, _elementCount, (int)_elementType, (int)_dataType), true) {
      if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    }
  ...
  public class AutoConstantEntry : global::System.IDisposable {
    ...
    public uint elementCount {
      ...
      get {
        uint ret = OgrePINVOKE.GpuProgramParameters_AutoConstantEntry_elementCount_get(swigCPtr);
        if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
        return ret;
      } 
    }
    ...
    public AutoConstantEntry(GpuProgramParameters.AutoConstantType theType, uint theIndex, uint theData, ushort theVariability, uint theElemCount) : this(OgrePINVOKE.new_GpuProgramParameters_AutoConstantEntry__SWIG_0((int)theType, theIndex, theData, theVariability, theElemCount), true) {
      if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    }
    ...
    public AutoConstantEntry(GpuProgramParameters.AutoConstantType theType, uint theIndex, float theData, ushort theVariability, uint theElemCount) : this(OgrePINVOKE.new_GpuProgramParameters_AutoConstantEntry__SWIG_2((int)theType, theIndex, theData, theVariability, theElemCount), true) {
      if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    }
  ...
  public void _writeRawConstants(uint physicalIndex, SWIGTYPE_p_float val, uint count) {
    OgrePINVOKE.GpuProgramParameters__writeRawConstants__SWIG_0(swigCPtr, physicalIndex, SWIGTYPE_p_float.getCPtr(val), count);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public void _writeRawConstants(uint physicalIndex, SWIGTYPE_p_double val, uint count) {
    OgrePINVOKE.GpuProgramParameters__writeRawConstants__SWIG_1(swigCPtr, physicalIndex, SWIGTYPE_p_double.getCPtr(val), count);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public void _writeRawConstants(uint physicalIndex, SWIGTYPE_p_int val, uint count) {
    OgrePINVOKE.GpuProgramParameters__writeRawConstants__SWIG_2(swigCPtr, physicalIndex, SWIGTYPE_p_int.getCPtr(val), count);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public void _writeRawConstants(uint physicalIndex, SWIGTYPE_p_unsigned_int val, uint count) {
    OgrePINVOKE.GpuProgramParameters__writeRawConstants__SWIG_3(swigCPtr, physicalIndex, SWIGTYPE_p_unsigned_int.getCPtr(val), count);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  public void _writeRawConstant(uint physicalIndex, Vector4 vec, uint count) {
    OgrePINVOKE.GpuProgramParameters__writeRawConstant__SWIG_0(swigCPtr, physicalIndex, Vector4.getCPtr(vec), count);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public void _writeRawConstant(uint physicalIndex, Vector4 vec) {
    OgrePINVOKE.GpuProgramParameters__writeRawConstant__SWIG_1(swigCPtr, physicalIndex, Vector4.getCPtr(vec));
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public void _writeRawConstant(uint physicalIndex, float val) {
    OgrePINVOKE.GpuProgramParameters__writeRawConstant__SWIG_2(swigCPtr, physicalIndex, val);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public void _writeRawConstant(uint physicalIndex, float val, uint count) {
    OgrePINVOKE.GpuProgramParameters__writeRawConstant__SWIG_3(swigCPtr, physicalIndex, val, count);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public void _writeRawConstant(uint physicalIndex, int val) {
    OgrePINVOKE.GpuProgramParameters__writeRawConstant__SWIG_4(swigCPtr, physicalIndex, val);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public void _writeRawConstant(uint physicalIndex, uint val) {
    OgrePINVOKE.GpuProgramParameters__writeRawConstant__SWIG_5(swigCPtr, physicalIndex, val);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public void _writeRawConstant(uint physicalIndex, Vector3 vec) {
    OgrePINVOKE.GpuProgramParameters__writeRawConstant__SWIG_6(swigCPtr, physicalIndex, Vector3.getCPtr(vec));
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public void _writeRawConstant(uint physicalIndex, Vector2 vec) {
    OgrePINVOKE.GpuProgramParameters__writeRawConstant__SWIG_7(swigCPtr, physicalIndex, Vector2.getCPtr(vec));
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public void _writeRawConstant(uint physicalIndex, Matrix4 m, uint elementCount) {
    OgrePINVOKE.GpuProgramParameters__writeRawConstant__SWIG_8(swigCPtr, physicalIndex, Matrix4.getCPtr(m), elementCount);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public void _writeRawConstant(uint physicalIndex, Matrix3 m, uint elementCount) {
    OgrePINVOKE.GpuProgramParameters__writeRawConstant__SWIG_9(swigCPtr, physicalIndex, Matrix3.getCPtr(m), elementCount);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public void _writeRawConstant(uint physicalIndex, TransformBaseReal m, uint numEntries) {
    OgrePINVOKE.GpuProgramParameters__writeRawConstant__SWIG_10(swigCPtr, physicalIndex, TransformBaseReal.getCPtr(m), numEntries);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public void _writeRawConstant(uint physicalIndex, ColourValue colour, uint count) {
    OgrePINVOKE.GpuProgramParameters__writeRawConstant__SWIG_11(swigCPtr, physicalIndex, ColourValue.getCPtr(colour), count);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public void _writeRawConstant(uint physicalIndex, ColourValue colour) {
    OgrePINVOKE.GpuProgramParameters__writeRawConstant__SWIG_12(swigCPtr, physicalIndex, ColourValue.getCPtr(colour));
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public SWIGTYPE_p_Ogre__ConstMapIteratorT_std__mapT_std__string_Ogre__GpuConstantDefinition_std__lessT_std__string_t_t_t getConstantDefinitionIterator() {
    SWIGTYPE_p_Ogre__ConstMapIteratorT_std__mapT_std__string_Ogre__GpuConstantDefinition_std__lessT_std__string_t_t_t ret = new SWIGTYPE_p_Ogre__ConstMapIteratorT_std__mapT_std__string_Ogre__GpuConstantDefinition_std__lessT_std__string_t_t_t(OgrePINVOKE.GpuProgramParameters_getConstantDefinitionIterator(swigCPtr), true);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public SWIGTYPE_p_Ogre__SharedPtrT_Ogre__GpuLogicalBufferStruct_t getFloatLogicalBufferStruct() {
    SWIGTYPE_p_Ogre__SharedPtrT_Ogre__GpuLogicalBufferStruct_t ret = new SWIGTYPE_p_Ogre__SharedPtrT_Ogre__GpuLogicalBufferStruct_t(OgrePINVOKE.GpuProgramParameters_getFloatLogicalBufferStruct(swigCPtr), false);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public SWIGTYPE_p_Ogre__SharedPtrT_Ogre__GpuLogicalBufferStruct_t getDoubleLogicalBufferStruct() {
    SWIGTYPE_p_Ogre__SharedPtrT_Ogre__GpuLogicalBufferStruct_t ret = new SWIGTYPE_p_Ogre__SharedPtrT_Ogre__GpuLogicalBufferStruct_t(OgrePINVOKE.GpuProgramParameters_getDoubleLogicalBufferStruct(swigCPtr), false);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public SWIGTYPE_p_Ogre__SharedPtrT_Ogre__GpuLogicalBufferStruct_t getIntLogicalBufferStruct() {
    SWIGTYPE_p_Ogre__SharedPtrT_Ogre__GpuLogicalBufferStruct_t ret = new SWIGTYPE_p_Ogre__SharedPtrT_Ogre__GpuLogicalBufferStruct_t(OgrePINVOKE.GpuProgramParameters_getIntLogicalBufferStruct(swigCPtr), false);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public uint getFloatLogicalIndexForPhysicalIndex(uint physicalIndex) {
    uint ret = OgrePINVOKE.GpuProgramParameters_getFloatLogicalIndexForPhysicalIndex(swigCPtr, physicalIndex);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public uint getDoubleLogicalIndexForPhysicalIndex(uint physicalIndex) {
    uint ret = OgrePINVOKE.GpuProgramParameters_getDoubleLogicalIndexForPhysicalIndex(swigCPtr, physicalIndex);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public uint getIntLogicalIndexForPhysicalIndex(uint physicalIndex) {
    uint ret = OgrePINVOKE.GpuProgramParameters_getIntLogicalIndexForPhysicalIndex(swigCPtr, physicalIndex);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public SWIGTYPE_p_std__vectorT_float_t getFloatConstantList() {
    SWIGTYPE_p_std__vectorT_float_t ret = new SWIGTYPE_p_std__vectorT_float_t(OgrePINVOKE.GpuProgramParameters_getFloatConstantList(swigCPtr), false);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public SWIGTYPE_p_std__vectorT_double_t getDoubleConstantList() {
    SWIGTYPE_p_std__vectorT_double_t ret = new SWIGTYPE_p_std__vectorT_double_t(OgrePINVOKE.GpuProgramParameters_getDoubleConstantList(swigCPtr), false);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public SWIGTYPE_p_std__vectorT_int_t getIntConstantList() {
    SWIGTYPE_p_std__vectorT_int_t ret = new SWIGTYPE_p_std__vectorT_int_t(OgrePINVOKE.GpuProgramParameters_getIntConstantList(swigCPtr), false);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public void _setRawAutoConstant(uint physicalIndex, GpuProgramParameters.AutoConstantType acType, uint extraInfo, ushort variability, uint elementSize) {
  ...
  public void _setRawAutoConstantReal(uint physicalIndex, GpuProgramParameters.AutoConstantType acType, float rData, ushort variability, uint elementSize) {
  ...
  public void setConstantFromTime(uint index, float factor) {
    OgrePINVOKE.GpuProgramParameters_setConstantFromTime(swigCPtr, index, factor);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  public GpuProgramParameters.AutoConstantEntry findDoubleAutoConstantEntry(uint logicalIndex) {
    global::System.IntPtr cPtr = OgrePINVOKE.GpuProgramParameters_findDoubleAutoConstantEntry(swigCPtr, logicalIndex);
    GpuProgramParameters.AutoConstantEntry ret = (cPtr == global::System.IntPtr.Zero) ? null : new GpuProgramParameters.AutoConstantEntry(cPtr, false);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public GpuProgramParameters.AutoConstantEntry findIntAutoConstantEntry(uint logicalIndex) {
    global::System.IntPtr cPtr = OgrePINVOKE.GpuProgramParameters_findIntAutoConstantEntry(swigCPtr, logicalIndex);
    GpuProgramParameters.AutoConstantEntry ret = (cPtr == global::System.IntPtr.Zero) ? null : new GpuProgramParameters.AutoConstantEntry(cPtr, false);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public GpuProgramParameters.AutoConstantEntry findUnsignedIntAutoConstantEntry(uint logicalIndex) {
    global::System.IntPtr cPtr = OgrePINVOKE.GpuProgramParameters_findUnsignedIntAutoConstantEntry(swigCPtr, logicalIndex);
    GpuProgramParameters.AutoConstantEntry ret = (cPtr == global::System.IntPtr.Zero) ? null : new GpuProgramParameters.AutoConstantEntry(cPtr, false);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public GpuProgramParameters.AutoConstantEntry _findRawAutoConstantEntryDouble(uint physicalIndex) {
    global::System.IntPtr cPtr = OgrePINVOKE.GpuProgramParameters__findRawAutoConstantEntryDouble(swigCPtr, physicalIndex);
    GpuProgramParameters.AutoConstantEntry ret = (cPtr == global::System.IntPtr.Zero) ? null : new GpuProgramParameters.AutoConstantEntry(cPtr, false);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public GpuProgramParameters.AutoConstantEntry _findRawAutoConstantEntryInt(uint physicalIndex) {
    global::System.IntPtr cPtr = OgrePINVOKE.GpuProgramParameters__findRawAutoConstantEntryInt(swigCPtr, physicalIndex);
    GpuProgramParameters.AutoConstantEntry ret = (cPtr == global::System.IntPtr.Zero) ? null : new GpuProgramParameters.AutoConstantEntry(cPtr, false);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public GpuProgramParameters.AutoConstantEntry _findRawAutoConstantEntryUnsignedInt(uint physicalIndex) {
    global::System.IntPtr cPtr = OgrePINVOKE.GpuProgramParameters__findRawAutoConstantEntryUnsignedInt(swigCPtr, physicalIndex);
    GpuProgramParameters.AutoConstantEntry ret = (cPtr == global::System.IntPtr.Zero) ? null : new GpuProgramParameters.AutoConstantEntry(cPtr, false);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public GpuProgramParameters.AutoConstantEntry _findRawAutoConstantEntryBool(uint physicalIndex) {
    global::System.IntPtr cPtr = OgrePINVOKE.GpuProgramParameters__findRawAutoConstantEntryBool(swigCPtr, physicalIndex);
    GpuProgramParameters.AutoConstantEntry ret = (cPtr == global::System.IntPtr.Zero) ? null : new GpuProgramParameters.AutoConstantEntry(cPtr, false);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public uint _getFloatConstantPhysicalIndex(uint logicalIndex, uint requestedSize, ushort variability) {
    uint ret = OgrePINVOKE.GpuProgramParameters__getFloatConstantPhysicalIndex(swigCPtr, logicalIndex, requestedSize, variability);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public uint _getDoubleConstantPhysicalIndex(uint logicalIndex, uint requestedSize, ushort variability) {
    uint ret = OgrePINVOKE.GpuProgramParameters__getDoubleConstantPhysicalIndex(swigCPtr, logicalIndex, requestedSize, variability);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public uint _getIntConstantPhysicalIndex(uint logicalIndex, uint requestedSize, ushort variability) {
    uint ret = OgrePINVOKE.GpuProgramParameters__getIntConstantPhysicalIndex(swigCPtr, logicalIndex, requestedSize, variability);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public static GpuProgramParameters.AutoConstantDefinition getAutoConstantDefinition(uint idx) {
    global::System.IntPtr cPtr = OgrePINVOKE.GpuProgramParameters_getAutoConstantDefinition__SWIG_1(idx);
    GpuProgramParameters.AutoConstantDefinition ret = (cPtr == global::System.IntPtr.Zero) ? null : new GpuProgramParameters.AutoConstantDefinition(cPtr, false);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public void _setRenderSystemData(Any data) {
    OgrePINVOKE.GpuProgramParameters__setRenderSystemData(swigCPtr, Any.getCPtr(data));
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public Any _getRenderSystemData() {
    Any ret = new Any(OgrePINVOKE.GpuProgramParameters__getRenderSystemData(swigCPtr), false);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public void setNamedSubroutine(string subroutineSlot, string subroutine) {
    OgrePINVOKE.GpuProgramParameters_setNamedSubroutine(swigCPtr, subroutineSlot, subroutine);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public void setSubroutine(uint index, string subroutine) {
    OgrePINVOKE.GpuProgramParameters_setSubroutine(swigCPtr, index, subroutine);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public SWIGTYPE_p_std__unordered_mapT_size_t_std__string_t getSubroutineMap() {
    SWIGTYPE_p_std__unordered_mapT_size_t_std__string_t ret = new SWIGTYPE_p_std__unordered_mapT_size_t_std__string_t(OgrePINVOKE.GpuProgramParameters_getSubroutineMap(swigCPtr), false);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
