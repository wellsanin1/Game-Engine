...
public class Viewport : global::System.IDisposable {
  ...
  public class Listener : global::System.IDisposable {
    ...
    private void SwigDirectorConnect() {
      if (SwigDerivedClassHasMethod("viewportCameraChanged", swigMethodTypes0))
        swigDelegate0 = new SwigDelegateListener_0(SwigDirectorviewportCameraChanged);
      if (SwigDerivedClassHasMethod("viewportDimensionsChanged", swigMethodTypes1))
        swigDelegate1 = new SwigDelegateListener_1(SwigDirectorviewportDimensionsChanged);
      if (SwigDerivedClassHasMethod("viewportDestroyed", swigMethodTypes2))
        swigDelegate2 = new SwigDelegateListener_2(SwigDirectorviewportDestroyed);
    ...
    private void SwigDirectorviewportCameraChanged(global::System.IntPtr viewport) {
      viewportCameraChanged((viewport == global::System.IntPtr.Zero) ? null : new Viewport(viewport, false));
    }
  
    private void SwigDirectorviewportDimensionsChanged(global::System.IntPtr viewport) {
      viewportDimensionsChanged((viewport == global::System.IntPtr.Zero) ? null : new Viewport(viewport, false));
    }
  
    private void SwigDirectorviewportDestroyed(global::System.IntPtr viewport) {
  ...
  public void setOrientationMode(OrientationMode orientationMode, bool setDefault) {
    OgrePINVOKE.Viewport_setOrientationMode__SWIG_0(swigCPtr, (int)orientationMode, setDefault);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  public OrientationMode getOrientationMode() {
    OrientationMode ret = (OrientationMode)OgrePINVOKE.Viewport_getOrientationMode(swigCPtr);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public void getActualDimensions(SWIGTYPE_p_int left, SWIGTYPE_p_int top, SWIGTYPE_p_int width, SWIGTYPE_p_int height) {
    OgrePINVOKE.Viewport_getActualDimensions(swigCPtr, SWIGTYPE_p_int.getCPtr(left), SWIGTYPE_p_int.getCPtr(top), SWIGTYPE_p_int.getCPtr(width), SWIGTYPE_p_int.getCPtr(height));
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  public virtual void setRenderQueueInvocationSequenceName(string sequenceName) {
    OgrePINVOKE.Viewport_setRenderQueueInvocationSequenceName(swigCPtr, sequenceName);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public virtual string getRenderQueueInvocationSequenceName() {
    string ret = OgrePINVOKE.Viewport_getRenderQueueInvocationSequenceName(swigCPtr);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public RenderQueueInvocationSequence _getRenderQueueInvocationSequence() {
    global::System.IntPtr cPtr = OgrePINVOKE.Viewport__getRenderQueueInvocationSequence(swigCPtr);
  ...
  public void pointOrientedToScreen(Vector2 v, int orientationMode, Vector2 outv) {
    OgrePINVOKE.Viewport_pointOrientedToScreen__SWIG_0(swigCPtr, Vector2.getCPtr(v), orientationMode, Vector2.getCPtr(outv));
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  public void pointOrientedToScreen(float orientedX, float orientedY, int orientationMode, SWIGTYPE_p_float screenX, SWIGTYPE_p_float screenY) {
    OgrePINVOKE.Viewport_pointOrientedToScreen__SWIG_1(swigCPtr, orientedX, orientedY, orientationMode, SWIGTYPE_p_float.getCPtr(screenX), SWIGTYPE_p_float.getCPtr(screenY));
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }
