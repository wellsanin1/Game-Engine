...
public class PatchMeshPtr : global::System.IDisposable {
  ...
  public void update(SWIGTYPE_p_void controlPointBuffer, uint width, uint height, uint uMaxSubdivisionLevel, uint vMaxSubdivisionLevel, PatchSurface.VisibleSide visibleSide) {
    OgrePINVOKE.PatchMeshPtr_update(swigCPtr, SWIGTYPE_p_void.getCPtr(controlPointBuffer), width, height, uMaxSubdivisionLevel, vMaxSubdivisionLevel, (int)visibleSide);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  public void define(SWIGTYPE_p_void controlPointBuffer, VertexDeclaration declaration, uint width, uint height, uint uMaxSubdivisionLevel, uint vMaxSubdivisionLevel, PatchSurface.VisibleSide visibleSide, HardwareBuffer.Usage vbUsage, HardwareBuffer.Usage ibUsage, bool vbUseShadow, bool ibUseShadow) {
    OgrePINVOKE.PatchMeshPtr_define__SWIG_0(swigCPtr, SWIGTYPE_p_void.getCPtr(controlPointBuffer), VertexDeclaration.getCPtr(declaration), width, height, uMaxSubdivisionLevel, vMaxSubdivisionLevel, (int)visibleSide, (int)vbUsage, (int)ibUsage, vbUseShadow, ibUseShadow);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  public void define(SWIGTYPE_p_void controlPointBuffer, VertexDeclaration declaration, uint width, uint height, uint uMaxSubdivisionLevel, uint vMaxSubdivisionLevel, PatchSurface.VisibleSide visibleSide, HardwareBuffer.Usage vbUsage, HardwareBuffer.Usage ibUsage, bool vbUseShadow) {
    OgrePINVOKE.PatchMeshPtr_define__SWIG_1(swigCPtr, SWIGTYPE_p_void.getCPtr(controlPointBuffer), VertexDeclaration.getCPtr(declaration), width, height, uMaxSubdivisionLevel, vMaxSubdivisionLevel, (int)visibleSide, (int)vbUsage, (int)ibUsage, vbUseShadow);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  public void define(SWIGTYPE_p_void controlPointBuffer, VertexDeclaration declaration, uint width, uint height, uint uMaxSubdivisionLevel, uint vMaxSubdivisionLevel, PatchSurface.VisibleSide visibleSide, HardwareBuffer.Usage vbUsage, HardwareBuffer.Usage ibUsage) {
    OgrePINVOKE.PatchMeshPtr_define__SWIG_2(swigCPtr, SWIGTYPE_p_void.getCPtr(controlPointBuffer), VertexDeclaration.getCPtr(declaration), width, height, uMaxSubdivisionLevel, vMaxSubdivisionLevel, (int)visibleSide, (int)vbUsage, (int)ibUsage);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  public void define(SWIGTYPE_p_void controlPointBuffer, VertexDeclaration declaration, uint width, uint height, uint uMaxSubdivisionLevel, uint vMaxSubdivisionLevel, PatchSurface.VisibleSide visibleSide, HardwareBuffer.Usage vbUsage) {
    OgrePINVOKE.PatchMeshPtr_define__SWIG_3(swigCPtr, SWIGTYPE_p_void.getCPtr(controlPointBuffer), VertexDeclaration.getCPtr(declaration), width, height, uMaxSubdivisionLevel, vMaxSubdivisionLevel, (int)visibleSide, (int)vbUsage);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  public void define(SWIGTYPE_p_void controlPointBuffer, VertexDeclaration declaration, uint width, uint height, uint uMaxSubdivisionLevel, uint vMaxSubdivisionLevel, PatchSurface.VisibleSide visibleSide) {
    OgrePINVOKE.PatchMeshPtr_define__SWIG_4(swigCPtr, SWIGTYPE_p_void.getCPtr(controlPointBuffer), VertexDeclaration.getCPtr(declaration), width, height, uMaxSubdivisionLevel, vMaxSubdivisionLevel, (int)visibleSide);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  public void define(SWIGTYPE_p_void controlPointBuffer, VertexDeclaration declaration, uint width, uint height, uint uMaxSubdivisionLevel, uint vMaxSubdivisionLevel) {
    OgrePINVOKE.PatchMeshPtr_define__SWIG_5(swigCPtr, SWIGTYPE_p_void.getCPtr(controlPointBuffer), VertexDeclaration.getCPtr(declaration), width, height, uMaxSubdivisionLevel, vMaxSubdivisionLevel);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  public void define(SWIGTYPE_p_void controlPointBuffer, VertexDeclaration declaration, uint width, uint height, uint uMaxSubdivisionLevel) {
    OgrePINVOKE.PatchMeshPtr_define__SWIG_6(swigCPtr, SWIGTYPE_p_void.getCPtr(controlPointBuffer), VertexDeclaration.getCPtr(declaration), width, height, uMaxSubdivisionLevel);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public void define(SWIGTYPE_p_void controlPointBuffer, VertexDeclaration declaration, uint width, uint height) {
    OgrePINVOKE.PatchMeshPtr_define__SWIG_7(swigCPtr, SWIGTYPE_p_void.getCPtr(controlPointBuffer), VertexDeclaration.getCPtr(declaration), width, height);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  public SWIGTYPE_p_Ogre__MapIteratorT_std__multimapT_size_t_Ogre__VertexBoneAssignment_s_t_t getBoneAssignmentIterator() {
    SWIGTYPE_p_Ogre__MapIteratorT_std__multimapT_size_t_Ogre__VertexBoneAssignment_s_t_t ret = new SWIGTYPE_p_Ogre__MapIteratorT_std__multimapT_size_t_Ogre__VertexBoneAssignment_s_t_t(OgrePINVOKE.PatchMeshPtr_getBoneAssignmentIterator(swigCPtr), true);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public SWIGTYPE_p_std__multimapT_size_t_Ogre__VertexBoneAssignment_s_t getBoneAssignments() {
    SWIGTYPE_p_std__multimapT_size_t_Ogre__VertexBoneAssignment_s_t ret = new SWIGTYPE_p_std__multimapT_size_t_Ogre__VertexBoneAssignment_s_t(OgrePINVOKE.PatchMeshPtr_getBoneAssignments(swigCPtr), false);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public void setVertexBufferPolicy(HardwareBuffer.Usage usage, bool shadowBuffer) {
    OgrePINVOKE.PatchMeshPtr_setVertexBufferPolicy__SWIG_0(swigCPtr, (int)usage, shadowBuffer);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public void setVertexBufferPolicy(HardwareBuffer.Usage usage) {
    OgrePINVOKE.PatchMeshPtr_setVertexBufferPolicy__SWIG_1(swigCPtr, (int)usage);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public void setIndexBufferPolicy(HardwareBuffer.Usage usage, bool shadowBuffer) {
    OgrePINVOKE.PatchMeshPtr_setIndexBufferPolicy__SWIG_0(swigCPtr, (int)usage, shadowBuffer);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public void setIndexBufferPolicy(HardwareBuffer.Usage usage) {
    OgrePINVOKE.PatchMeshPtr_setIndexBufferPolicy__SWIG_1(swigCPtr, (int)usage);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public HardwareBuffer.Usage getVertexBufferUsage() {
    HardwareBuffer.Usage ret = (HardwareBuffer.Usage)OgrePINVOKE.PatchMeshPtr_getVertexBufferUsage(swigCPtr);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public HardwareBuffer.Usage getIndexBufferUsage() {
    HardwareBuffer.Usage ret = (HardwareBuffer.Usage)OgrePINVOKE.PatchMeshPtr_getIndexBufferUsage(swigCPtr);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public ushort _rationaliseBoneAssignments(uint vertexCount, SWIGTYPE_p_std__multimapT_size_t_Ogre__VertexBoneAssignment_s_t assignments) {
    ushort ret = OgrePINVOKE.PatchMeshPtr__rationaliseBoneAssignments(swigCPtr, vertexCount, SWIGTYPE_p_std__multimapT_size_t_Ogre__VertexBoneAssignment_s_t.getCPtr(assignments));
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public void buildTangentVectors(VertexElementSemantic targetSemantic, ushort sourceTexCoordSet, ushort index, bool splitMirrored, bool splitRotated, bool storeParityInW) {
    OgrePINVOKE.PatchMeshPtr_buildTangentVectors__SWIG_0(swigCPtr, (int)targetSemantic, sourceTexCoordSet, index, splitMirrored, splitRotated, storeParityInW);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  public void buildTangentVectors(VertexElementSemantic targetSemantic, ushort sourceTexCoordSet, ushort index, bool splitMirrored, bool splitRotated) {
    OgrePINVOKE.PatchMeshPtr_buildTangentVectors__SWIG_1(swigCPtr, (int)targetSemantic, sourceTexCoordSet, index, splitMirrored, splitRotated);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  public void buildTangentVectors(VertexElementSemantic targetSemantic, ushort sourceTexCoordSet, ushort index, bool splitMirrored) {
    OgrePINVOKE.PatchMeshPtr_buildTangentVectors__SWIG_2(swigCPtr, (int)targetSemantic, sourceTexCoordSet, index, splitMirrored);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public void buildTangentVectors(VertexElementSemantic targetSemantic, ushort sourceTexCoordSet, ushort index) {
    OgrePINVOKE.PatchMeshPtr_buildTangentVectors__SWIG_3(swigCPtr, (int)targetSemantic, sourceTexCoordSet, index);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public void buildTangentVectors(VertexElementSemantic targetSemantic, ushort sourceTexCoordSet) {
    OgrePINVOKE.PatchMeshPtr_buildTangentVectors__SWIG_4(swigCPtr, (int)targetSemantic, sourceTexCoordSet);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public void buildTangentVectors(VertexElementSemantic targetSemantic) {
    OgrePINVOKE.PatchMeshPtr_buildTangentVectors__SWIG_5(swigCPtr, (int)targetSemantic);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public void buildTangentVectors() {
    OgrePINVOKE.PatchMeshPtr_buildTangentVectors__SWIG_6(swigCPtr);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  public bool suggestTangentVectorBuildParams(VertexElementSemantic targetSemantic, SWIGTYPE_p_unsigned_short outSourceCoordSet, SWIGTYPE_p_unsigned_short outIndex) {
    bool ret = OgrePINVOKE.PatchMeshPtr_suggestTangentVectorBuildParams(swigCPtr, (int)targetSemantic, SWIGTYPE_p_unsigned_short.getCPtr(outSourceCoordSet), SWIGTYPE_p_unsigned_short.getCPtr(outIndex));
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public void softwareVertexPoseBlend(float weight, SWIGTYPE_p_std__mapT_size_t_Ogre__VectorT_3_Ogre__Real_t_std__lessT_size_t_t_t vertexOffsetMap, SWIGTYPE_p_std__mapT_size_t_Ogre__VectorT_3_Ogre__Real_t_std__lessT_size_t_t_t normalsMap, VertexData targetVertexData) {
    OgrePINVOKE.PatchMeshPtr_softwareVertexPoseBlend(swigCPtr, weight, SWIGTYPE_p_std__mapT_size_t_Ogre__VectorT_3_Ogre__Real_t_std__lessT_size_t_t_t.getCPtr(vertexOffsetMap), SWIGTYPE_p_std__mapT_size_t_Ogre__VectorT_3_Ogre__Real_t_std__lessT_size_t_t_t.getCPtr(normalsMap), VertexData.getCPtr(targetVertexData));
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  public void updateMaterialForAllSubMeshes() {
    OgrePINVOKE.PatchMeshPtr_updateMaterialForAllSubMeshes(swigCPtr);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  public void setLodStrategy(SWIGTYPE_p_Ogre__LodStrategy lodStrategy) {
    OgrePINVOKE.PatchMeshPtr_setLodStrategy(swigCPtr, SWIGTYPE_p_Ogre__LodStrategy.getCPtr(lodStrategy));
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  public ulong getHandle() {
    ulong ret = OgrePINVOKE.PatchMeshPtr_getHandle(swigCPtr);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public void _fireLoadingComplete(bool wasBackgroundLoaded) {
    OgrePINVOKE.PatchMeshPtr__fireLoadingComplete(swigCPtr, wasBackgroundLoaded);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public void _firePreparingComplete(bool wasBackgroundLoaded) {
    OgrePINVOKE.PatchMeshPtr__firePreparingComplete(swigCPtr, wasBackgroundLoaded);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  public SWIGTYPE_p_std__vectorT_Ogre__ParameterDef_t getParameters() {
    SWIGTYPE_p_std__vectorT_Ogre__ParameterDef_t ret = new SWIGTYPE_p_std__vectorT_Ogre__ParameterDef_t(OgrePINVOKE.PatchMeshPtr_getParameters(swigCPtr), false);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public void setParameterList(NameValuePairList paramList) {
    OgrePINVOKE.PatchMeshPtr_setParameterList(swigCPtr, NameValuePairList.getCPtr(paramList));
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }
