...
public class TextureUnitState : global::System.IDisposable {
  ...
  public class TextureEffect : global::System.IDisposable {
    ...
    public ControllerReal controller {
      set {
        OgrePINVOKE.TextureUnitState_TextureEffect_controller_set(swigCPtr, ControllerReal.getCPtr(value));
        if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
      } 
      get {
  ...
  public TextureUnitState(Pass parent, string texName, uint texCoordSet) : this(OgrePINVOKE.new_TextureUnitState__SWIG_2(Pass.getCPtr(parent), texName, texCoordSet), true) {
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  public void setAnimatedTextureName(StringVector names, float duration) {
    OgrePINVOKE.TextureUnitState_setAnimatedTextureName__SWIG_4(swigCPtr, StringVector.getCPtr(names), duration);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public void setAnimatedTextureName(StringVector names) {
    OgrePINVOKE.TextureUnitState_setAnimatedTextureName__SWIG_5(swigCPtr, StringVector.getCPtr(names));
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public void setLayerArrayNames(TextureType type, StringVector names) {
    OgrePINVOKE.TextureUnitState_setLayerArrayNames(swigCPtr, (int)type, StringVector.getCPtr(names));
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public SWIGTYPE_p_std__pairT_size_t_size_t_t getTextureDimensions(uint frame) {
    SWIGTYPE_p_std__pairT_size_t_size_t_t ret = new SWIGTYPE_p_std__pairT_size_t_size_t_t(OgrePINVOKE.TextureUnitState_getTextureDimensions__SWIG_0(swigCPtr, frame), true);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public SWIGTYPE_p_std__pairT_size_t_size_t_t getTextureDimensions() {
    SWIGTYPE_p_std__pairT_size_t_size_t_t ret = new SWIGTYPE_p_std__pairT_size_t_size_t_t(OgrePINVOKE.TextureUnitState_getTextureDimensions__SWIG_1(swigCPtr), true);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public void setBindingType(TextureUnitState.BindingType bt) {
    OgrePINVOKE.TextureUnitState_setBindingType(swigCPtr, (int)bt);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public TextureUnitState.BindingType getBindingType() {
    TextureUnitState.BindingType ret = (TextureUnitState.BindingType)OgrePINVOKE.TextureUnitState_getBindingType(swigCPtr);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public void setIsAlpha(bool isAlpha) {
    OgrePINVOKE.TextureUnitState_setIsAlpha(swigCPtr, isAlpha);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public bool getIsAlpha() {
    bool ret = OgrePINVOKE.TextureUnitState_getIsAlpha(swigCPtr);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public uint getTextureCoordSet() {
    uint ret = OgrePINVOKE.TextureUnitState_getTextureCoordSet(swigCPtr);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public void setEnvironmentMap(bool enable, TextureUnitState.EnvMapType envMapType) {
    OgrePINVOKE.TextureUnitState_setEnvironmentMap__SWIG_0(swigCPtr, enable, (int)envMapType);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  public void setTransformAnimation(TextureUnitState.TextureTransformType ttype, WaveformType waveType, float arg2, float frequency, float phase, float amplitude) {
    OgrePINVOKE.TextureUnitState_setTransformAnimation__SWIG_0(swigCPtr, (int)ttype, (int)waveType, arg2, frequency, phase, amplitude);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public void setTransformAnimation(TextureUnitState.TextureTransformType ttype, WaveformType waveType, float arg2, float frequency, float phase) {
    OgrePINVOKE.TextureUnitState_setTransformAnimation__SWIG_1(swigCPtr, (int)ttype, (int)waveType, arg2, frequency, phase);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public void setTransformAnimation(TextureUnitState.TextureTransformType ttype, WaveformType waveType, float arg2, float frequency) {
    OgrePINVOKE.TextureUnitState_setTransformAnimation__SWIG_2(swigCPtr, (int)ttype, (int)waveType, arg2, frequency);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public void setTransformAnimation(TextureUnitState.TextureTransformType ttype, WaveformType waveType, float arg2) {
    OgrePINVOKE.TextureUnitState_setTransformAnimation__SWIG_3(swigCPtr, (int)ttype, (int)waveType, arg2);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  public bool hasViewRelativeTextureCoordinateGeneration() {
    bool ret = OgrePINVOKE.TextureUnitState_hasViewRelativeTextureCoordinateGeneration(swigCPtr);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public void setTextureNameAlias(string name) {
    OgrePINVOKE.TextureUnitState_setTextureNameAlias(swigCPtr, name);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public string getTextureNameAlias() {
    string ret = OgrePINVOKE.TextureUnitState_getTextureNameAlias(swigCPtr);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public bool applyTextureAliases(NameValuePairList aliasList, bool apply) {
    bool ret = OgrePINVOKE.TextureUnitState_applyTextureAliases__SWIG_0(swigCPtr, NameValuePairList.getCPtr(aliasList), apply);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public bool applyTextureAliases(NameValuePairList aliasList) {
    bool ret = OgrePINVOKE.TextureUnitState_applyTextureAliases__SWIG_1(swigCPtr, NameValuePairList.getCPtr(aliasList));
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public static readonly TextureAddressingMode TAM_UNKNOWN = (TextureAddressingMode)OgrePINVOKE.TextureUnitState_TAM_UNKNOWN_get();
