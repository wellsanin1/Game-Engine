...
public class Entity : MovableObject {
  ...
  public SWIGTYPE_p_Ogre__VectorIteratorT_std__vectorT_Ogre__MovableObject_p_t_t getAttachedObjectIterator() {
    SWIGTYPE_p_Ogre__VectorIteratorT_std__vectorT_Ogre__MovableObject_p_t_t ret = new SWIGTYPE_p_Ogre__VectorIteratorT_std__vectorT_Ogre__MovableObject_p_t_t(OgrePINVOKE.Entity_getAttachedObjectIterator(swigCPtr), true);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public SWIGTYPE_p_std__vectorT_Ogre__MovableObject_p_t getAttachedObjects() {
    SWIGTYPE_p_std__vectorT_Ogre__MovableObject_p_t ret = new SWIGTYPE_p_std__vectorT_Ogre__MovableObject_p_t(OgrePINVOKE.Entity_getAttachedObjects(swigCPtr), false);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public override bool hasEdgeList() {
    bool ret = OgrePINVOKE.Entity_hasEdgeList(swigCPtr);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public override SWIGTYPE_p_Ogre__VectorIteratorT_std__vectorT_Ogre__ShadowRenderable_p_t_t getShadowVolumeRenderableIterator(ShadowTechnique shadowTechnique, Light light, HardwareIndexBufferPtr indexBuffer, SWIGTYPE_p_size_t indexBufferUsedSize, bool extrudeVertices, float extrusionDistance, uint flags) {
    SWIGTYPE_p_Ogre__VectorIteratorT_std__vectorT_Ogre__ShadowRenderable_p_t_t ret = new SWIGTYPE_p_Ogre__VectorIteratorT_std__vectorT_Ogre__ShadowRenderable_p_t_t(OgrePINVOKE.Entity_getShadowVolumeRenderableIterator__SWIG_0(swigCPtr, (int)shadowTechnique, Light.getCPtr(light), HardwareIndexBufferPtr.getCPtr(indexBuffer), SWIGTYPE_p_size_t.getCPtr(indexBufferUsedSize), extrudeVertices, extrusionDistance, flags), true);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public TempBlendedBufferInfo _getSkelAnimTempBufferInfo() {
    global::System.IntPtr cPtr = OgrePINVOKE.Entity__getSkelAnimTempBufferInfo(swigCPtr);
    TempBlendedBufferInfo ret = (cPtr == global::System.IntPtr.Zero) ? null : new TempBlendedBufferInfo(cPtr, false);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public TempBlendedBufferInfo _getVertexAnimTempBufferInfo() {
    global::System.IntPtr cPtr = OgrePINVOKE.Entity__getVertexAnimTempBufferInfo(swigCPtr);
    TempBlendedBufferInfo ret = (cPtr == global::System.IntPtr.Zero) ? null : new TempBlendedBufferInfo(cPtr, false);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
