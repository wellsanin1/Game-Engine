...
public class TexturePtr : global::System.IDisposable {
  ...
  public void freeInternalResources() {
    OgrePINVOKE.TexturePtr_freeInternalResources(swigCPtr);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  public void setTreatLuminanceAsAlpha(bool asAlpha) {
    OgrePINVOKE.TexturePtr_setTreatLuminanceAsAlpha(swigCPtr, asAlpha);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public bool getTreatLuminanceAsAlpha() {
    bool ret = OgrePINVOKE.TexturePtr_getTreatLuminanceAsAlpha(swigCPtr);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public void getCustomAttribute(string name, SWIGTYPE_p_void pData) {
    OgrePINVOKE.TexturePtr_getCustomAttribute__SWIG_0(swigCPtr, name, SWIGTYPE_p_void.getCPtr(pData));
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  public void setLayerNames(StringVector names) {
    OgrePINVOKE.TexturePtr_setLayerNames(swigCPtr, StringVector.getCPtr(names));
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  public ulong getHandle() {
    ulong ret = OgrePINVOKE.TexturePtr_getHandle(swigCPtr);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public void _fireLoadingComplete(bool wasBackgroundLoaded) {
    OgrePINVOKE.TexturePtr__fireLoadingComplete(swigCPtr, wasBackgroundLoaded);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public void _firePreparingComplete(bool wasBackgroundLoaded) {
    OgrePINVOKE.TexturePtr__firePreparingComplete(swigCPtr, wasBackgroundLoaded);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  public SWIGTYPE_p_std__vectorT_Ogre__ParameterDef_t getParameters() {
    SWIGTYPE_p_std__vectorT_Ogre__ParameterDef_t ret = new SWIGTYPE_p_std__vectorT_Ogre__ParameterDef_t(OgrePINVOKE.TexturePtr_getParameters(swigCPtr), false);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public void setParameterList(NameValuePairList paramList) {
    OgrePINVOKE.TexturePtr_setParameterList(swigCPtr, NameValuePairList.getCPtr(paramList));
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }
