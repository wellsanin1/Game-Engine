...
public class ConfigFile : global::System.IDisposable {
  ...
  public StringVector getMultiSetting(string key, string section) {
    StringVector ret = new StringVector(OgrePINVOKE.ConfigFile_getMultiSetting__SWIG_0(swigCPtr, key, section), true);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public StringVector getMultiSetting(string key) {
    StringVector ret = new StringVector(OgrePINVOKE.ConfigFile_getMultiSetting__SWIG_1(swigCPtr, key), true);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public SettingsBySection getSettingsBySection() {
    SettingsBySection ret = new SettingsBySection(OgrePINVOKE.ConfigFile_getSettingsBySection(swigCPtr), false);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
