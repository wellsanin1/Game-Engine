...
public class ResourceManager : ScriptLoader {
  ...
  public bool resourceExists(ulong handle) {
  ...
  public ResourcePtr prepare(string name, string group, bool isManual, ManualResourceLoader loader, NameValuePairList loadParams, bool backgroundThread) {
    ResourcePtr ret = new ResourcePtr(OgrePINVOKE.ResourceManager_prepare__SWIG_0(swigCPtr, name, group, isManual, ManualResourceLoader.getCPtr(loader), NameValuePairList.getCPtr(loadParams), backgroundThread), true);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public ResourcePtr prepare(string name, string group, bool isManual, ManualResourceLoader loader, NameValuePairList loadParams) {
    ResourcePtr ret = new ResourcePtr(OgrePINVOKE.ResourceManager_prepare__SWIG_1(swigCPtr, name, group, isManual, ManualResourceLoader.getCPtr(loader), NameValuePairList.getCPtr(loadParams)), true);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public override StringVector getScriptPatterns() {
    StringVector ret = new StringVector(OgrePINVOKE.ResourceManager_getScriptPatterns(swigCPtr), false);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
