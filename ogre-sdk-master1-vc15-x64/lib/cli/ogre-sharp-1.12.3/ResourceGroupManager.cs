...
public class ResourceGroupManager : global::System.IDisposable {
  ...
  public class ResourceDeclaration : global::System.IDisposable {
    ...
    public NameValuePairList parameters {
      set {
        OgrePINVOKE.ResourceGroupManager_ResourceDeclaration_parameters_set(swigCPtr, NameValuePairList.getCPtr(value));
        if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
      } 
      get {
  ...
  public void prepareResourceGroup(string name, bool prepareMainResources, bool prepareWorldGeom) {
    OgrePINVOKE.ResourceGroupManager_prepareResourceGroup__SWIG_0(swigCPtr, name, prepareMainResources, prepareWorldGeom);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public void prepareResourceGroup(string name, bool prepareMainResources) {
    OgrePINVOKE.ResourceGroupManager_prepareResourceGroup__SWIG_1(swigCPtr, name, prepareMainResources);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public void prepareResourceGroup(string name) {
    OgrePINVOKE.ResourceGroupManager_prepareResourceGroup__SWIG_2(swigCPtr, name);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public void loadResourceGroup(string name, bool loadMainResources, bool loadWorldGeom) {
    OgrePINVOKE.ResourceGroupManager_loadResourceGroup__SWIG_0(swigCPtr, name, loadMainResources, loadWorldGeom);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public void loadResourceGroup(string name, bool loadMainResources) {
    OgrePINVOKE.ResourceGroupManager_loadResourceGroup__SWIG_1(swigCPtr, name, loadMainResources);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public void loadResourceGroup(string name) {
    OgrePINVOKE.ResourceGroupManager_loadResourceGroup__SWIG_2(swigCPtr, name);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  public void declareResource(string name, string resourceType, string groupName, NameValuePairList loadParameters) {
    OgrePINVOKE.ResourceGroupManager_declareResource__SWIG_0(swigCPtr, name, resourceType, groupName, NameValuePairList.getCPtr(loadParameters));
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  public void declareResource(string name, string resourceType, string groupName, ManualResourceLoader loader, NameValuePairList loadParameters) {
    OgrePINVOKE.ResourceGroupManager_declareResource__SWIG_3(swigCPtr, name, resourceType, groupName, ManualResourceLoader.getCPtr(loader), NameValuePairList.getCPtr(loadParameters));
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  public StringVectorPtr listResourceNames(string groupName, bool dirs) {
    StringVectorPtr ret = new StringVectorPtr(OgrePINVOKE.ResourceGroupManager_listResourceNames__SWIG_0(swigCPtr, groupName, dirs), true);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public StringVectorPtr listResourceNames(string groupName) {
    StringVectorPtr ret = new StringVectorPtr(OgrePINVOKE.ResourceGroupManager_listResourceNames__SWIG_1(swigCPtr, groupName), true);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public StringVectorPtr findResourceNames(string groupName, string pattern, bool dirs) {
    StringVectorPtr ret = new StringVectorPtr(OgrePINVOKE.ResourceGroupManager_findResourceNames__SWIG_0(swigCPtr, groupName, pattern, dirs), true);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public StringVectorPtr findResourceNames(string groupName, string pattern) {
    StringVectorPtr ret = new StringVectorPtr(OgrePINVOKE.ResourceGroupManager_findResourceNames__SWIG_1(swigCPtr, groupName, pattern), true);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public void linkWorldGeometryToResourceGroup(string group, string worldGeometry, SceneManager sceneManager) {
    OgrePINVOKE.ResourceGroupManager_linkWorldGeometryToResourceGroup(swigCPtr, group, worldGeometry, SceneManager.getCPtr(sceneManager));
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public void unlinkWorldGeometryFromResourceGroup(string group) {
    OgrePINVOKE.ResourceGroupManager_unlinkWorldGeometryFromResourceGroup(swigCPtr, group);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  public SWIGTYPE_p_Ogre__MapIteratorT_std__mapT_std__string_Ogre__ResourceManager_p_std__lessT_std__string_t_t_t getResourceManagerIterator() {
    SWIGTYPE_p_Ogre__MapIteratorT_std__mapT_std__string_Ogre__ResourceManager_p_std__lessT_std__string_t_t_t ret = new SWIGTYPE_p_Ogre__MapIteratorT_std__mapT_std__string_Ogre__ResourceManager_p_std__lessT_std__string_t_t_t(OgrePINVOKE.ResourceGroupManager_getResourceManagerIterator(swigCPtr), true);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public void _notifyWorldGeometryStageStarted(string description) {
    OgrePINVOKE.ResourceGroupManager__notifyWorldGeometryStageStarted(swigCPtr, description);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public void _notifyWorldGeometryStageEnded() {
    OgrePINVOKE.ResourceGroupManager__notifyWorldGeometryStageEnded(swigCPtr);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public StringVector getResourceGroups() {
    StringVector ret = new StringVector(OgrePINVOKE.ResourceGroupManager_getResourceGroups(swigCPtr), true);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
