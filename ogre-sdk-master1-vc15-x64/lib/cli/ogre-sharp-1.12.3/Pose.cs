...
public class Pose : global::System.IDisposable {
  ...
  public SWIGTYPE_p_Ogre__ConstMapIteratorT_std__mapT_size_t_Ogre__VectorT_3_Ogre__Real_t_std__lessT_size_t_t_t_t getVertexOffsetIterator() {
    SWIGTYPE_p_Ogre__ConstMapIteratorT_std__mapT_size_t_Ogre__VectorT_3_Ogre__Real_t_std__lessT_size_t_t_t_t ret = new SWIGTYPE_p_Ogre__ConstMapIteratorT_std__mapT_size_t_Ogre__VectorT_3_Ogre__Real_t_std__lessT_size_t_t_t_t(OgrePINVOKE.Pose_getVertexOffsetIterator__SWIG_0(swigCPtr), true);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public SWIGTYPE_p_std__mapT_size_t_Ogre__VectorT_3_Ogre__Real_t_std__lessT_size_t_t_t getVertexOffsets() {
    SWIGTYPE_p_std__mapT_size_t_Ogre__VectorT_3_Ogre__Real_t_std__lessT_size_t_t_t ret = new SWIGTYPE_p_std__mapT_size_t_Ogre__VectorT_3_Ogre__Real_t_std__lessT_size_t_t_t(OgrePINVOKE.Pose_getVertexOffsets(swigCPtr), false);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public SWIGTYPE_p_std__mapT_size_t_Ogre__VectorT_3_Ogre__Real_t_std__lessT_size_t_t_t getNormals() {
    SWIGTYPE_p_std__mapT_size_t_Ogre__VectorT_3_Ogre__Real_t_std__lessT_size_t_t_t ret = new SWIGTYPE_p_std__mapT_size_t_Ogre__VectorT_3_Ogre__Real_t_std__lessT_size_t_t_t(OgrePINVOKE.Pose_getNormals(swigCPtr), false);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
