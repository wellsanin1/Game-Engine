...
public class OverlayElement : StringInterface {
  ...
  internal OverlayElement(global::System.IntPtr cPtr, bool cMemoryOwn) : base(OgreOverlayPINVOKE.OverlayElement_SWIGSmartPtrUpcast(cPtr), true) {
  ...
  public virtual void setCaption(SWIGTYPE_p_UTFString text) {
    OgreOverlayPINVOKE.OverlayElement_setCaption(swigCPtr, SWIGTYPE_p_UTFString.getCPtr(text));
    if (OgreOverlayPINVOKE.SWIGPendingException.Pending) throw OgreOverlayPINVOKE.SWIGPendingException.Retrieve();
  }

  public virtual SWIGTYPE_p_UTFString getCaption() {
    SWIGTYPE_p_UTFString ret = new SWIGTYPE_p_UTFString(OgreOverlayPINVOKE.OverlayElement_getCaption(swigCPtr), false);
    if (OgreOverlayPINVOKE.SWIGPendingException.Pending) throw OgreOverlayPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public virtual GuiMetricsMode getMetricsMode() {
  ...
  public virtual GuiVerticalAlignment getVerticalAlignment() {
  ...
  public OverlayElement getSourceTemplate() {
    global::System.IntPtr cPtr = OgreOverlayPINVOKE.OverlayElement_getSourceTemplate(swigCPtr);
    OverlayElement ret = (cPtr == global::System.IntPtr.Zero) ? null : new OverlayElement(cPtr, true);
    if (OgreOverlayPINVOKE.SWIGPendingException.Pending) throw OgreOverlayPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
