...
public class PSSMShadowCameraSetup : LiSPSMShadowCameraSetup {
  ...
  public void setSplitPoints(SWIGTYPE_p_std__vectorT_float_t newSplitPoints) {
    OgrePINVOKE.PSSMShadowCameraSetup_setSplitPoints(swigCPtr, SWIGTYPE_p_std__vectorT_float_t.getCPtr(newSplitPoints));
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  public SWIGTYPE_p_std__vectorT_float_t getSplitPoints() {
    SWIGTYPE_p_std__vectorT_float_t ret = new SWIGTYPE_p_std__vectorT_float_t(OgrePINVOKE.PSSMShadowCameraSetup_getSplitPoints(swigCPtr), false);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
