...
public class LogManager : global::System.IDisposable {
  ...
  public Log.Stream stream(LogMessageLevel lml, bool maskDebug) {
    Log.Stream ret = new Log.Stream(OgrePINVOKE.LogManager_stream__SWIG_0(swigCPtr, (int)lml, maskDebug), true);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public Log.Stream stream(LogMessageLevel lml) {
    Log.Stream ret = new Log.Stream(OgrePINVOKE.LogManager_stream__SWIG_1(swigCPtr, (int)lml), true);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public Log.Stream stream() {
    Log.Stream ret = new Log.Stream(OgrePINVOKE.LogManager_stream__SWIG_2(swigCPtr), true);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public void setLogDetail(LoggingLevel ll) {
    OgrePINVOKE.LogManager_setLogDetail(swigCPtr, (int)ll);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }
