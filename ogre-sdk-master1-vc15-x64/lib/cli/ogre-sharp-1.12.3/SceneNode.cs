...
public class SceneNode : Node {
  ...
  public ushort numAttachedObjects() {
    ushort ret = OgrePINVOKE.SceneNode_numAttachedObjects(swigCPtr);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public SWIGTYPE_p_std__vectorT_Ogre__MovableObject_p_t getAttachedObjects() {
    SWIGTYPE_p_std__vectorT_Ogre__MovableObject_p_t ret = new SWIGTYPE_p_std__vectorT_Ogre__MovableObject_p_t(OgrePINVOKE.SceneNode_getAttachedObjects(swigCPtr), false);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public void hideBoundingBox(bool bHide) {
    OgrePINVOKE.SceneNode_hideBoundingBox(swigCPtr, bHide);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  public void findLights(SWIGTYPE_p_Ogre__HashedVectorT_Ogre__Light_p_t destList, float radius, uint lightMask) {
    OgrePINVOKE.SceneNode_findLights__SWIG_0(swigCPtr, SWIGTYPE_p_Ogre__HashedVectorT_Ogre__Light_p_t.getCPtr(destList), radius, lightMask);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  public Node.DebugRenderable getDebugRenderable() {
    global::System.IntPtr cPtr = OgrePINVOKE.SceneNode_getDebugRenderable__SWIG_0(swigCPtr);
    Node.DebugRenderable ret = (cPtr == global::System.IntPtr.Zero) ? null : new Node.DebugRenderable(cPtr, false);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public new Node.DebugRenderable getDebugRenderable(float scaling) {
    global::System.IntPtr cPtr = OgrePINVOKE.SceneNode_getDebugRenderable__SWIG_1_0(swigCPtr, scaling);
    Node.DebugRenderable ret = (cPtr == global::System.IntPtr.Zero) ? null : new Node.DebugRenderable(cPtr, false);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
