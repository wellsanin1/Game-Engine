...
public class FileStreamDataStreamPtr : global::System.IDisposable {
  ...
  public uint read(SWIGTYPE_p_void buf, uint count) {
    uint ret = OgrePINVOKE.FileStreamDataStreamPtr_read(swigCPtr, SWIGTYPE_p_void.getCPtr(buf), count);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public uint write(SWIGTYPE_p_void buf, uint count) {
    uint ret = OgrePINVOKE.FileStreamDataStreamPtr_write(swigCPtr, SWIGTYPE_p_void.getCPtr(buf), count);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
