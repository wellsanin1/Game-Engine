...
public class FileHandleDataStream : DataStream {
  ...
  public override uint read(SWIGTYPE_p_void buf, uint count) {
    uint ret = OgrePINVOKE.FileHandleDataStream_read(swigCPtr, SWIGTYPE_p_void.getCPtr(buf), count);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public override uint write(SWIGTYPE_p_void buf, uint count) {
    uint ret = OgrePINVOKE.FileHandleDataStream_write(swigCPtr, SWIGTYPE_p_void.getCPtr(buf), count);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
