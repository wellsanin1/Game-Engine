...
public class MovableObject : ShadowCaster {
  ...
  public class Listener : global::System.IDisposable {
    ...
    private void SwigDirectorobjectDestroyed(global::System.IntPtr arg0) {
      objectDestroyed((arg0 == global::System.IntPtr.Zero) ? null : new MovableObject(arg0, false));
    }
  
    private void SwigDirectorobjectAttached(global::System.IntPtr arg0) {
      objectAttached((arg0 == global::System.IntPtr.Zero) ? null : new MovableObject(arg0, false));
    }
  
    private void SwigDirectorobjectDetached(global::System.IntPtr arg0) {
      objectDetached((arg0 == global::System.IntPtr.Zero) ? null : new MovableObject(arg0, false));
    }
  
    private void SwigDirectorobjectMoved(global::System.IntPtr arg0) {
      objectMoved((arg0 == global::System.IntPtr.Zero) ? null : new MovableObject(arg0, false));
    }
  
    private bool SwigDirectorobjectRendering(global::System.IntPtr arg0, global::System.IntPtr arg1) {
  ...
  public override bool hasEdgeList() {
    bool ret = OgrePINVOKE.MovableObject_hasEdgeList(swigCPtr);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public override SWIGTYPE_p_Ogre__VectorIteratorT_std__vectorT_Ogre__ShadowRenderable_p_t_t getShadowVolumeRenderableIterator(ShadowTechnique shadowTechnique, Light light, HardwareIndexBufferPtr indexBuffer, SWIGTYPE_p_size_t indexBufferUsedSize, bool extrudeVertices, float extrusionDist, uint flags) {
    SWIGTYPE_p_Ogre__VectorIteratorT_std__vectorT_Ogre__ShadowRenderable_p_t_t ret = new SWIGTYPE_p_Ogre__VectorIteratorT_std__vectorT_Ogre__ShadowRenderable_p_t_t(OgrePINVOKE.MovableObject_getShadowVolumeRenderableIterator__SWIG_0(swigCPtr, (int)shadowTechnique, Light.getCPtr(light), HardwareIndexBufferPtr.getCPtr(indexBuffer), SWIGTYPE_p_size_t.getCPtr(indexBufferUsedSize), extrudeVertices, extrusionDist, flags), true);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public override SWIGTYPE_p_Ogre__VectorIteratorT_std__vectorT_Ogre__ShadowRenderable_p_t_t getShadowVolumeRenderableIterator(ShadowTechnique shadowTechnique, Light light, HardwareIndexBufferPtr indexBuffer, SWIGTYPE_p_size_t indexBufferUsedSize, bool extrudeVertices, float extrusionDist) {
    SWIGTYPE_p_Ogre__VectorIteratorT_std__vectorT_Ogre__ShadowRenderable_p_t_t ret = new SWIGTYPE_p_Ogre__VectorIteratorT_std__vectorT_Ogre__ShadowRenderable_p_t_t(OgrePINVOKE.MovableObject_getShadowVolumeRenderableIterator__SWIG_1(swigCPtr, (int)shadowTechnique, Light.getCPtr(light), HardwareIndexBufferPtr.getCPtr(indexBuffer), SWIGTYPE_p_size_t.getCPtr(indexBufferUsedSize), extrudeVertices, extrusionDist), true);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
