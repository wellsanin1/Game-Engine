...
public class PixelUtil : global::System.IDisposable {
  ...
  public static uint getNumElemBytes(PixelFormat format) {
    uint ret = OgrePINVOKE.PixelUtil_getNumElemBytes((int)format);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public static uint getNumElemBits(PixelFormat format) {
    uint ret = OgrePINVOKE.PixelUtil_getNumElemBits((int)format);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public static uint getComponentCount(PixelFormat fmt) {
    uint ret = OgrePINVOKE.PixelUtil_getComponentCount((int)fmt);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public static void packColour(ColourValue colour, PixelFormat pf, SWIGTYPE_p_void dest) {
    OgrePINVOKE.PixelUtil_packColour__SWIG_0(ColourValue.getCPtr(colour), (int)pf, SWIGTYPE_p_void.getCPtr(dest));
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public static void packColour(byte r, byte g, byte b, byte a, PixelFormat pf, SWIGTYPE_p_void dest) {
    OgrePINVOKE.PixelUtil_packColour__SWIG_1(r, g, b, a, (int)pf, SWIGTYPE_p_void.getCPtr(dest));
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }
