...
public class ManualObject : MovableObject {
  ...
  public virtual void tangent(Vector3 tan) {
    OgrePINVOKE.ManualObject_tangent__SWIG_0(swigCPtr, Vector3.getCPtr(tan));
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public virtual void tangent(float x, float y, float z) {
  ...
  public virtual void textureCoord(float x, float y, float z, float w) {
  ...
  public virtual void textureCoord(Vector4 xyzw) {
  ...
  public virtual void colour(float r, float g, float b, float a) {
    OgrePINVOKE.ManualObject_colour__SWIG_1(swigCPtr, r, g, b, a);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public virtual void colour(float r, float g, float b) {
  ...
  public virtual void setMaterialName(uint subIndex, string name, string group) {
    OgrePINVOKE.ManualObject_setMaterialName__SWIG_0(swigCPtr, subIndex, name, group);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public virtual void setMaterialName(uint subIndex, string name) {
  ...
  public override bool hasEdgeList() {
    bool ret = OgrePINVOKE.ManualObject_hasEdgeList(swigCPtr);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public override SWIGTYPE_p_Ogre__VectorIteratorT_std__vectorT_Ogre__ShadowRenderable_p_t_t getShadowVolumeRenderableIterator(ShadowTechnique shadowTechnique, Light light, HardwareIndexBufferPtr indexBuffer, SWIGTYPE_p_size_t indexBufferUsedSize, bool extrudeVertices, float extrusionDist, uint flags) {
    SWIGTYPE_p_Ogre__VectorIteratorT_std__vectorT_Ogre__ShadowRenderable_p_t_t ret = new SWIGTYPE_p_Ogre__VectorIteratorT_std__vectorT_Ogre__ShadowRenderable_p_t_t(OgrePINVOKE.ManualObject_getShadowVolumeRenderableIterator__SWIG_0(swigCPtr, (int)shadowTechnique, Light.getCPtr(light), HardwareIndexBufferPtr.getCPtr(indexBuffer), SWIGTYPE_p_size_t.getCPtr(indexBufferUsedSize), extrudeVertices, extrusionDist, flags), true);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public class ManualObjectSectionShadowRenderable : ShadowRenderable {
    ...
    internal static global::System.Runtime.InteropServices.HandleRef getCPtr(ManualObjectSectionShadowRenderable obj) {
      return (obj == null) ? new global::System.Runtime.InteropServices.HandleRef(null, global::System.IntPtr.Zero) : obj.swigCPtr;
    }
    ...
    public override void Dispose() {
      lock(this) {
        if (swigCPtr.Handle != global::System.IntPtr.Zero) {
          if (swigCMemOwn) {
            swigCMemOwn = false;
            OgrePINVOKE.delete_ManualObject_ManualObjectSectionShadowRenderable(swigCPtr);
          }
          swigCPtr = new global::System.Runtime.InteropServices.HandleRef(null, global::System.IntPtr.Zero);
        }
        global::System.GC.SuppressFinalize(this);
    ...
    public ManualObjectSectionShadowRenderable(ManualObject parent, HardwareIndexBufferPtr indexBuffer, VertexData vertexData, bool createSeparateLightCap, bool isLightCap) : this(OgrePINVOKE.new_ManualObject_ManualObjectSectionShadowRenderable__SWIG_0(ManualObject.getCPtr(parent), HardwareIndexBufferPtr.getCPtr(indexBuffer), VertexData.getCPtr(vertexData), createSeparateLightCap, isLightCap), true) {
      if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    }
    ...
    public void getWorldTransforms(Matrix4 xform) {
      OgrePINVOKE.ManualObject_ManualObjectSectionShadowRenderable_getWorldTransforms(swigCPtr, Matrix4.getCPtr(xform));
      if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    }
  
    public HardwareVertexBufferPtr getPositionBuffer() {
      HardwareVertexBufferPtr ret = new HardwareVertexBufferPtr(OgrePINVOKE.ManualObject_ManualObjectSectionShadowRenderable_getPositionBuffer(swigCPtr), true);
      if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
      return ret;
    }
    ...
    public override void rebindIndexBuffer(HardwareIndexBufferPtr indexBuffer) {
      OgrePINVOKE.ManualObject_ManualObjectSectionShadowRenderable_rebindIndexBuffer(swigCPtr, HardwareIndexBufferPtr.getCPtr(indexBuffer));
      if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    }
