...
public class CompositionPass : global::System.IDisposable {
  ...
  public uint getClearStencil() {
    uint ret = OgrePINVOKE.CompositionPass_getClearStencil(swigCPtr);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public void setStencilReadBackAsTextureOperation(bool value) {
    OgrePINVOKE.CompositionPass_setStencilReadBackAsTextureOperation(swigCPtr, value);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public bool getStencilReadBackAsTextureOperation() {
    bool ret = OgrePINVOKE.CompositionPass_getStencilReadBackAsTextureOperation(swigCPtr);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public void setQuadCorners(FloatRect quad) {
    OgrePINVOKE.CompositionPass_setQuadCorners__SWIG_0(swigCPtr, FloatRect.getCPtr(quad));
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public void setQuadCorners(float left, float top, float right, float bottom) {
    OgrePINVOKE.CompositionPass_setQuadCorners__SWIG_1(swigCPtr, left, top, right, bottom);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public bool getQuadCorners(FloatRect quad) {
    bool ret = OgrePINVOKE.CompositionPass_getQuadCorners__SWIG_0(swigCPtr, FloatRect.getCPtr(quad));
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public bool getQuadCorners(SWIGTYPE_p_float left, SWIGTYPE_p_float top, SWIGTYPE_p_float right, SWIGTYPE_p_float bottom) {
    bool ret = OgrePINVOKE.CompositionPass_getQuadCorners__SWIG_1(swigCPtr, SWIGTYPE_p_float.getCPtr(left), SWIGTYPE_p_float.getCPtr(top), SWIGTYPE_p_float.getCPtr(right), SWIGTYPE_p_float.getCPtr(bottom));
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
