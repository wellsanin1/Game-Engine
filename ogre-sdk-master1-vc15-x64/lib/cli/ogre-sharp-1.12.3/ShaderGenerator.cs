...
public class ShaderGenerator : global::System.IDisposable {
  ...
  public bool hasShaderBasedTechnique(string materialName, string srcTechniqueSchemeName, string dstTechniqueSchemeName) {
    bool ret = RTShaderPINVOKE.ShaderGenerator_hasShaderBasedTechnique__SWIG_0(swigCPtr, materialName, srcTechniqueSchemeName, dstTechniqueSchemeName);
    if (RTShaderPINVOKE.SWIGPendingException.Pending) throw RTShaderPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public bool hasShaderBasedTechnique(string materialName, string groupName, string srcTechniqueSchemeName, string dstTechniqueSchemeName) {
    bool ret = RTShaderPINVOKE.ShaderGenerator_hasShaderBasedTechnique__SWIG_1(swigCPtr, materialName, groupName, srcTechniqueSchemeName, dstTechniqueSchemeName);
    if (RTShaderPINVOKE.SWIGPendingException.Pending) throw RTShaderPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public bool cloneShaderBasedTechniques(string srcMaterialName, string srcGroupName, string dstMaterialName, string dstGroupName) {
    bool ret = RTShaderPINVOKE.ShaderGenerator_cloneShaderBasedTechniques(swigCPtr, srcMaterialName, srcGroupName, dstMaterialName, dstGroupName);
    if (RTShaderPINVOKE.SWIGPendingException.Pending) throw RTShaderPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
