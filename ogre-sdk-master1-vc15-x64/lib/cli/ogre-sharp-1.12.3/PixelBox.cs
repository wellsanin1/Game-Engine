...
public class PixelBox : Box {
  ...
  public PixelBox(Box extents, PixelFormat pixelFormat, SWIGTYPE_p_void pixelData) : this(OgrePINVOKE.new_PixelBox__SWIG_1(Box.getCPtr(extents), (int)pixelFormat, SWIGTYPE_p_void.getCPtr(pixelData)), true) {
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  public PixelBox(uint width, uint height, uint depth, PixelFormat pixelFormat, SWIGTYPE_p_void pixelData) : this(OgrePINVOKE.new_PixelBox__SWIG_3(width, height, depth, (int)pixelFormat, SWIGTYPE_p_void.getCPtr(pixelData)), true) {
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }
