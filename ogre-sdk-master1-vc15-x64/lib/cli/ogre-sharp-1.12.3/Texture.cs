...
public class Texture : Resource {
  ...
  public void freeInternalResources() {
    OgrePINVOKE.Texture_freeInternalResources(swigCPtr);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  public void setTreatLuminanceAsAlpha(bool asAlpha) {
    OgrePINVOKE.Texture_setTreatLuminanceAsAlpha(swigCPtr, asAlpha);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public bool getTreatLuminanceAsAlpha() {
    bool ret = OgrePINVOKE.Texture_getTreatLuminanceAsAlpha(swigCPtr);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public virtual void getCustomAttribute(string name, SWIGTYPE_p_void pData) {
    OgrePINVOKE.Texture_getCustomAttribute__SWIG_0(swigCPtr, name, SWIGTYPE_p_void.getCPtr(pData));
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  public void setLayerNames(StringVector names) {
    OgrePINVOKE.Texture_setLayerNames(swigCPtr, StringVector.getCPtr(names));
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }
