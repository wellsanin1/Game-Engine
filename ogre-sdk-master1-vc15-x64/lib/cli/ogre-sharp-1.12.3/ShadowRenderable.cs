...
public class ShadowRenderable : Renderable {
  ...
  public SWIGTYPE_p_Ogre__HashedVectorT_Ogre__Light_p_t getLights() {
    SWIGTYPE_p_Ogre__HashedVectorT_Ogre__Light_p_t ret = new SWIGTYPE_p_Ogre__HashedVectorT_Ogre__Light_p_t(OgrePINVOKE.ShadowRenderable_getLights(swigCPtr), false);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public virtual void rebindIndexBuffer(HardwareIndexBufferPtr indexBuffer) {
