...
public class Root : global::System.IDisposable {
  ...
  public RenderWindow initialise(bool autoCreateWindow, string windowTitle, string customCapabilitiesConfig) {
    global::System.IntPtr cPtr = OgrePINVOKE.Root_initialise__SWIG_0(swigCPtr, autoCreateWindow, windowTitle, customCapabilitiesConfig);
  ...
  public RenderWindow initialise(bool autoCreateWindow, string windowTitle) {
    global::System.IntPtr cPtr = OgrePINVOKE.Root_initialise__SWIG_1(swigCPtr, autoCreateWindow, windowTitle);
    RenderWindow ret = (cPtr == global::System.IntPtr.Zero) ? null : new RenderWindow(cPtr, false);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public RenderWindow initialise(bool autoCreateWindow) {
    global::System.IntPtr cPtr = OgrePINVOKE.Root_initialise__SWIG_2(swigCPtr, autoCreateWindow);
    RenderWindow ret = (cPtr == global::System.IntPtr.Zero) ? null : new RenderWindow(cPtr, false);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public SceneManagerMetaData getSceneManagerMetaData(string typeName) {
    global::System.IntPtr cPtr = OgrePINVOKE.Root_getSceneManagerMetaData__SWIG_0(swigCPtr, typeName);
  ...
  public SWIGTYPE_p_std__vectorT_Ogre__SceneManagerMetaData_const_p_t getSceneManagerMetaData() {
    SWIGTYPE_p_std__vectorT_Ogre__SceneManagerMetaData_const_p_t ret = new SWIGTYPE_p_std__vectorT_Ogre__SceneManagerMetaData_const_p_t(OgrePINVOKE.Root_getSceneManagerMetaData__SWIG_1(swigCPtr), false);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public RenderWindow createRenderWindow(string name, uint width, uint height, bool fullScreen, NameValuePairList miscParams) {
    global::System.IntPtr cPtr = OgrePINVOKE.Root_createRenderWindow__SWIG_0(swigCPtr, name, width, height, fullScreen, NameValuePairList.getCPtr(miscParams));
    RenderWindow ret = (cPtr == global::System.IntPtr.Zero) ? null : new RenderWindow(cPtr, false);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public void _pushCurrentSceneManager(SceneManager sm) {
    OgrePINVOKE.Root__pushCurrentSceneManager(swigCPtr, SceneManager.getCPtr(sm));
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public void _popCurrentSceneManager(SceneManager sm) {
    OgrePINVOKE.Root__popCurrentSceneManager(swigCPtr, SceneManager.getCPtr(sm));
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  public RenderQueueInvocationSequence createRenderQueueInvocationSequence(string name) {
    global::System.IntPtr cPtr = OgrePINVOKE.Root_createRenderQueueInvocationSequence(swigCPtr, name);
    RenderQueueInvocationSequence ret = (cPtr == global::System.IntPtr.Zero) ? null : new RenderQueueInvocationSequence(cPtr, false);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public RenderQueueInvocationSequence getRenderQueueInvocationSequence(string name) {
    global::System.IntPtr cPtr = OgrePINVOKE.Root_getRenderQueueInvocationSequence(swigCPtr, name);
    RenderQueueInvocationSequence ret = (cPtr == global::System.IntPtr.Zero) ? null : new RenderQueueInvocationSequence(cPtr, false);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public void destroyRenderQueueInvocationSequence(string name) {
    OgrePINVOKE.Root_destroyRenderQueueInvocationSequence(swigCPtr, name);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public void destroyAllRenderQueueInvocationSequences() {
    OgrePINVOKE.Root_destroyAllRenderQueueInvocationSequences(swigCPtr);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  public SWIGTYPE_p_Ogre__ConstMapIteratorT_std__mapT_std__string_Ogre__MovableObjectFactory_p_std__lessT_std__string_t_t_t getMovableObjectFactoryIterator() {
    SWIGTYPE_p_Ogre__ConstMapIteratorT_std__mapT_std__string_Ogre__MovableObjectFactory_p_std__lessT_std__string_t_t_t ret = new SWIGTYPE_p_Ogre__ConstMapIteratorT_std__mapT_std__string_Ogre__MovableObjectFactory_p_std__lessT_std__string_t_t_t(OgrePINVOKE.Root_getMovableObjectFactoryIterator(swigCPtr), true);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public uint getDisplayMonitorCount() {
    uint ret = OgrePINVOKE.Root_getDisplayMonitorCount(swigCPtr);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
