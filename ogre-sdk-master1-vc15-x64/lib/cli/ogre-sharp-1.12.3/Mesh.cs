...
public class Mesh : Resource {
  ...
  public Mesh(ResourceManager creator, string name, ulong handle, string group, bool isManual, ManualResourceLoader loader) : this(OgrePINVOKE.new_Mesh__SWIG_0(ResourceManager.getCPtr(creator), name, handle, group, isManual, ManualResourceLoader.getCPtr(loader)), true) {
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public Mesh(ResourceManager creator, string name, ulong handle, string group, bool isManual) : this(OgrePINVOKE.new_Mesh__SWIG_1(ResourceManager.getCPtr(creator), name, handle, group, isManual), true) {
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public Mesh(ResourceManager creator, string name, ulong handle, string group) : this(OgrePINVOKE.new_Mesh__SWIG_2(ResourceManager.getCPtr(creator), name, handle, group), true) {
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  public SWIGTYPE_p_Ogre__MapIteratorT_std__multimapT_size_t_Ogre__VertexBoneAssignment_s_t_t getBoneAssignmentIterator() {
    SWIGTYPE_p_Ogre__MapIteratorT_std__multimapT_size_t_Ogre__VertexBoneAssignment_s_t_t ret = new SWIGTYPE_p_Ogre__MapIteratorT_std__multimapT_size_t_Ogre__VertexBoneAssignment_s_t_t(OgrePINVOKE.Mesh_getBoneAssignmentIterator(swigCPtr), true);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public SWIGTYPE_p_std__multimapT_size_t_Ogre__VertexBoneAssignment_s_t getBoneAssignments() {
    SWIGTYPE_p_std__multimapT_size_t_Ogre__VertexBoneAssignment_s_t ret = new SWIGTYPE_p_std__multimapT_size_t_Ogre__VertexBoneAssignment_s_t(OgrePINVOKE.Mesh_getBoneAssignments(swigCPtr), false);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public void setVertexBufferPolicy(HardwareBuffer.Usage usage, bool shadowBuffer) {
    OgrePINVOKE.Mesh_setVertexBufferPolicy__SWIG_0(swigCPtr, (int)usage, shadowBuffer);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public void setVertexBufferPolicy(HardwareBuffer.Usage usage) {
    OgrePINVOKE.Mesh_setVertexBufferPolicy__SWIG_1(swigCPtr, (int)usage);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public void setIndexBufferPolicy(HardwareBuffer.Usage usage, bool shadowBuffer) {
    OgrePINVOKE.Mesh_setIndexBufferPolicy__SWIG_0(swigCPtr, (int)usage, shadowBuffer);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public void setIndexBufferPolicy(HardwareBuffer.Usage usage) {
    OgrePINVOKE.Mesh_setIndexBufferPolicy__SWIG_1(swigCPtr, (int)usage);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public HardwareBuffer.Usage getVertexBufferUsage() {
    HardwareBuffer.Usage ret = (HardwareBuffer.Usage)OgrePINVOKE.Mesh_getVertexBufferUsage(swigCPtr);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public HardwareBuffer.Usage getIndexBufferUsage() {
    HardwareBuffer.Usage ret = (HardwareBuffer.Usage)OgrePINVOKE.Mesh_getIndexBufferUsage(swigCPtr);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public ushort _rationaliseBoneAssignments(uint vertexCount, SWIGTYPE_p_std__multimapT_size_t_Ogre__VertexBoneAssignment_s_t assignments) {
    ushort ret = OgrePINVOKE.Mesh__rationaliseBoneAssignments(swigCPtr, vertexCount, SWIGTYPE_p_std__multimapT_size_t_Ogre__VertexBoneAssignment_s_t.getCPtr(assignments));
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public void buildTangentVectors(VertexElementSemantic targetSemantic, ushort sourceTexCoordSet, ushort index, bool splitMirrored, bool splitRotated, bool storeParityInW) {
    OgrePINVOKE.Mesh_buildTangentVectors__SWIG_0(swigCPtr, (int)targetSemantic, sourceTexCoordSet, index, splitMirrored, splitRotated, storeParityInW);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  public void buildTangentVectors(VertexElementSemantic targetSemantic, ushort sourceTexCoordSet, ushort index, bool splitMirrored) {
    OgrePINVOKE.Mesh_buildTangentVectors__SWIG_2(swigCPtr, (int)targetSemantic, sourceTexCoordSet, index, splitMirrored);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public void buildTangentVectors(VertexElementSemantic targetSemantic, ushort sourceTexCoordSet, ushort index) {
    OgrePINVOKE.Mesh_buildTangentVectors__SWIG_3(swigCPtr, (int)targetSemantic, sourceTexCoordSet, index);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  public void buildTangentVectors() {
    OgrePINVOKE.Mesh_buildTangentVectors__SWIG_6(swigCPtr);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  public static void softwareVertexPoseBlend(float weight, SWIGTYPE_p_std__mapT_size_t_Ogre__VectorT_3_Ogre__Real_t_std__lessT_size_t_t_t vertexOffsetMap, SWIGTYPE_p_std__mapT_size_t_Ogre__VectorT_3_Ogre__Real_t_std__lessT_size_t_t_t normalsMap, VertexData targetVertexData) {
    OgrePINVOKE.Mesh_softwareVertexPoseBlend(weight, SWIGTYPE_p_std__mapT_size_t_Ogre__VectorT_3_Ogre__Real_t_std__lessT_size_t_t_t.getCPtr(vertexOffsetMap), SWIGTYPE_p_std__mapT_size_t_Ogre__VectorT_3_Ogre__Real_t_std__lessT_size_t_t_t.getCPtr(normalsMap), VertexData.getCPtr(targetVertexData));
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  public void updateMaterialForAllSubMeshes() {
    OgrePINVOKE.Mesh_updateMaterialForAllSubMeshes(swigCPtr);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  public void setLodStrategy(SWIGTYPE_p_Ogre__LodStrategy lodStrategy) {
    OgrePINVOKE.Mesh_setLodStrategy(swigCPtr, SWIGTYPE_p_Ogre__LodStrategy.getCPtr(lodStrategy));
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }
