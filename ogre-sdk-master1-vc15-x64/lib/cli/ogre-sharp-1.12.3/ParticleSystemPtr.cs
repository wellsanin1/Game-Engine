...
public class ParticleSystemPtr : global::System.IDisposable {
  ...
  public ParticleIterator _getIterator() {
    ParticleIterator ret = new ParticleIterator(OgrePINVOKE.ParticleSystemPtr__getIterator(swigCPtr), true);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public void _notifyParticleResized() {
    OgrePINVOKE.ParticleSystemPtr__notifyParticleResized(swigCPtr);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public void _notifyParticleRotated() {
    OgrePINVOKE.ParticleSystemPtr__notifyParticleRotated(swigCPtr);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  public SWIGTYPE_p_std__vectorT_Ogre__ParameterDef_t getParameters() {
    SWIGTYPE_p_std__vectorT_Ogre__ParameterDef_t ret = new SWIGTYPE_p_std__vectorT_Ogre__ParameterDef_t(OgrePINVOKE.ParticleSystemPtr_getParameters(swigCPtr), false);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public void setParameterList(NameValuePairList paramList) {
    OgrePINVOKE.ParticleSystemPtr_setParameterList(swigCPtr, NameValuePairList.getCPtr(paramList));
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  public SWIGTYPE_p_Ogre__HashedVectorT_Ogre__Light_p_t queryLights() {
    SWIGTYPE_p_Ogre__HashedVectorT_Ogre__Light_p_t ret = new SWIGTYPE_p_Ogre__HashedVectorT_Ogre__Light_p_t(OgrePINVOKE.ParticleSystemPtr_queryLights(swigCPtr), false);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public SWIGTYPE_p_Ogre__VectorIteratorT_std__vectorT_Ogre__ShadowRenderable_p_t_t getShadowVolumeRenderableIterator(ShadowTechnique shadowTechnique, Light light, HardwareIndexBufferPtr indexBuffer, SWIGTYPE_p_size_t indexBufferUsedSize, bool extrudeVertices, float extrusionDist, uint flags) {
    SWIGTYPE_p_Ogre__VectorIteratorT_std__vectorT_Ogre__ShadowRenderable_p_t_t ret = new SWIGTYPE_p_Ogre__VectorIteratorT_std__vectorT_Ogre__ShadowRenderable_p_t_t(OgrePINVOKE.ParticleSystemPtr_getShadowVolumeRenderableIterator__SWIG_0(swigCPtr, (int)shadowTechnique, Light.getCPtr(light), HardwareIndexBufferPtr.getCPtr(indexBuffer), SWIGTYPE_p_size_t.getCPtr(indexBufferUsedSize), extrudeVertices, extrusionDist, flags), true);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public SWIGTYPE_p_Ogre__VectorIteratorT_std__vectorT_Ogre__ShadowRenderable_p_t_t getShadowVolumeRenderableIterator(ShadowTechnique shadowTechnique, Light light, HardwareIndexBufferPtr indexBuffer, SWIGTYPE_p_size_t indexBufferUsedSize, bool extrudeVertices, float extrusionDist) {
    SWIGTYPE_p_Ogre__VectorIteratorT_std__vectorT_Ogre__ShadowRenderable_p_t_t ret = new SWIGTYPE_p_Ogre__VectorIteratorT_std__vectorT_Ogre__ShadowRenderable_p_t_t(OgrePINVOKE.ParticleSystemPtr_getShadowVolumeRenderableIterator__SWIG_1(swigCPtr, (int)shadowTechnique, Light.getCPtr(light), HardwareIndexBufferPtr.getCPtr(indexBuffer), SWIGTYPE_p_size_t.getCPtr(indexBufferUsedSize), extrudeVertices, extrusionDist), true);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
