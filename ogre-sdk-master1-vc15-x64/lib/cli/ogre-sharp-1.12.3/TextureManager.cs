...
public class TextureManager : ResourceManager {
  ...
  public TexturePtr create(string name, string group, bool isManual, ManualResourceLoader loader, NameValuePairList createParams) {
    TexturePtr ret = new TexturePtr(OgrePINVOKE.TextureManager_create__SWIG_0(swigCPtr, name, group, isManual, ManualResourceLoader.getCPtr(loader), NameValuePairList.getCPtr(createParams)), true);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public new SWIGTYPE_p_std__pairT_Ogre__SharedPtrT_Ogre__Resource_t_bool_t createOrRetrieve(string name, string group, bool isManual, ManualResourceLoader loader, NameValuePairList createParams) {
    SWIGTYPE_p_std__pairT_Ogre__SharedPtrT_Ogre__Resource_t_bool_t ret = new SWIGTYPE_p_std__pairT_Ogre__SharedPtrT_Ogre__Resource_t_bool_t(OgrePINVOKE.TextureManager_createOrRetrieve__SWIG_0_0(swigCPtr, name, group, isManual, ManualResourceLoader.getCPtr(loader), NameValuePairList.getCPtr(createParams)), true);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public SWIGTYPE_p_std__pairT_Ogre__SharedPtrT_Ogre__Resource_t_bool_t createOrRetrieve(string name, string group, bool isManual, ManualResourceLoader loader, NameValuePairList createParams, TextureType texType, int numMipmaps, float gamma, bool isAlpha, PixelFormat desiredFormat, bool hwGammaCorrection) {
    SWIGTYPE_p_std__pairT_Ogre__SharedPtrT_Ogre__Resource_t_bool_t ret = new SWIGTYPE_p_std__pairT_Ogre__SharedPtrT_Ogre__Resource_t_bool_t(OgrePINVOKE.TextureManager_createOrRetrieve__SWIG_1(swigCPtr, name, group, isManual, ManualResourceLoader.getCPtr(loader), NameValuePairList.getCPtr(createParams), (int)texType, numMipmaps, gamma, isAlpha, (int)desiredFormat, hwGammaCorrection), true);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public SWIGTYPE_p_std__pairT_Ogre__SharedPtrT_Ogre__Resource_t_bool_t createOrRetrieve(string name, string group, bool isManual, ManualResourceLoader loader, NameValuePairList createParams, TextureType texType, int numMipmaps, float gamma, bool isAlpha, PixelFormat desiredFormat) {
    SWIGTYPE_p_std__pairT_Ogre__SharedPtrT_Ogre__Resource_t_bool_t ret = new SWIGTYPE_p_std__pairT_Ogre__SharedPtrT_Ogre__Resource_t_bool_t(OgrePINVOKE.TextureManager_createOrRetrieve__SWIG_2(swigCPtr, name, group, isManual, ManualResourceLoader.getCPtr(loader), NameValuePairList.getCPtr(createParams), (int)texType, numMipmaps, gamma, isAlpha, (int)desiredFormat), true);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public SWIGTYPE_p_std__pairT_Ogre__SharedPtrT_Ogre__Resource_t_bool_t createOrRetrieve(string name, string group, bool isManual, ManualResourceLoader loader, NameValuePairList createParams, TextureType texType, int numMipmaps, float gamma, bool isAlpha) {
    SWIGTYPE_p_std__pairT_Ogre__SharedPtrT_Ogre__Resource_t_bool_t ret = new SWIGTYPE_p_std__pairT_Ogre__SharedPtrT_Ogre__Resource_t_bool_t(OgrePINVOKE.TextureManager_createOrRetrieve__SWIG_3(swigCPtr, name, group, isManual, ManualResourceLoader.getCPtr(loader), NameValuePairList.getCPtr(createParams), (int)texType, numMipmaps, gamma, isAlpha), true);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public SWIGTYPE_p_std__pairT_Ogre__SharedPtrT_Ogre__Resource_t_bool_t createOrRetrieve(string name, string group, bool isManual, ManualResourceLoader loader, NameValuePairList createParams, TextureType texType, int numMipmaps) {
    SWIGTYPE_p_std__pairT_Ogre__SharedPtrT_Ogre__Resource_t_bool_t ret = new SWIGTYPE_p_std__pairT_Ogre__SharedPtrT_Ogre__Resource_t_bool_t(OgrePINVOKE.TextureManager_createOrRetrieve__SWIG_5(swigCPtr, name, group, isManual, ManualResourceLoader.getCPtr(loader), NameValuePairList.getCPtr(createParams), (int)texType, numMipmaps), true);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public SWIGTYPE_p_std__pairT_Ogre__SharedPtrT_Ogre__Resource_t_bool_t createOrRetrieve(string name, string group, bool isManual, ManualResourceLoader loader, NameValuePairList createParams, TextureType texType) {
    SWIGTYPE_p_std__pairT_Ogre__SharedPtrT_Ogre__Resource_t_bool_t ret = new SWIGTYPE_p_std__pairT_Ogre__SharedPtrT_Ogre__Resource_t_bool_t(OgrePINVOKE.TextureManager_createOrRetrieve__SWIG_6(swigCPtr, name, group, isManual, ManualResourceLoader.getCPtr(loader), NameValuePairList.getCPtr(createParams), (int)texType), true);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public TexturePtr load(string name, string group, TextureType texType, int numMipmaps, float gamma, bool isAlpha, PixelFormat desiredFormat, bool hwGammaCorrection) {
    TexturePtr ret = new TexturePtr(OgrePINVOKE.TextureManager_load__SWIG_0(swigCPtr, name, group, (int)texType, numMipmaps, gamma, isAlpha, (int)desiredFormat, hwGammaCorrection), true);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public TexturePtr load(string name, string group, TextureType texType, int numMipmaps, float gamma, bool isAlpha, PixelFormat desiredFormat) {
    TexturePtr ret = new TexturePtr(OgrePINVOKE.TextureManager_load__SWIG_1(swigCPtr, name, group, (int)texType, numMipmaps, gamma, isAlpha, (int)desiredFormat), true);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public TexturePtr load(string name, string group, TextureType texType, int numMipmaps, float gamma, bool isAlpha) {
    TexturePtr ret = new TexturePtr(OgrePINVOKE.TextureManager_load__SWIG_2(swigCPtr, name, group, (int)texType, numMipmaps, gamma, isAlpha), true);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public TexturePtr load(string name, string group, TextureType texType, int numMipmaps, float gamma) {
    TexturePtr ret = new TexturePtr(OgrePINVOKE.TextureManager_load__SWIG_3(swigCPtr, name, group, (int)texType, numMipmaps, gamma), true);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public TexturePtr load(string name, string group, TextureType texType, int numMipmaps) {
    TexturePtr ret = new TexturePtr(OgrePINVOKE.TextureManager_load__SWIG_4(swigCPtr, name, group, (int)texType, numMipmaps), true);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public TexturePtr load(string name, string group, TextureType texType) {
    TexturePtr ret = new TexturePtr(OgrePINVOKE.TextureManager_load__SWIG_5(swigCPtr, name, group, (int)texType), true);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public TexturePtr load(string name, string group) {
    TexturePtr ret = new TexturePtr(OgrePINVOKE.TextureManager_load__SWIG_6(swigCPtr, name, group), true);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public TexturePtr createManual(string name, string group, TextureType texType, uint width, uint height, int numMipmaps, PixelFormat format, int usage) {
    TexturePtr ret = new TexturePtr(OgrePINVOKE.TextureManager_createManual__SWIG_10(swigCPtr, name, group, (int)texType, width, height, numMipmaps, (int)format, usage), true);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public TexturePtr createManual(string name, string group, TextureType texType, uint width, uint height, int numMipmaps, PixelFormat format) {
    TexturePtr ret = new TexturePtr(OgrePINVOKE.TextureManager_createManual__SWIG_11(swigCPtr, name, group, (int)texType, width, height, numMipmaps, (int)format), true);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
