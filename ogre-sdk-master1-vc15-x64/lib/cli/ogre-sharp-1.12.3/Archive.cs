...
public class Archive : global::System.IDisposable {
  ...
  public virtual StringVectorPtr list(bool recursive) {
    StringVectorPtr ret = new StringVectorPtr(OgrePINVOKE.Archive_list__SWIG_1(swigCPtr, recursive), true);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public virtual StringVectorPtr find(string pattern, bool recursive, bool dirs) {
    StringVectorPtr ret = new StringVectorPtr(OgrePINVOKE.Archive_find__SWIG_0(swigCPtr, pattern, recursive, dirs), true);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public virtual StringVectorPtr find(string pattern, bool recursive) {
    StringVectorPtr ret = new StringVectorPtr(OgrePINVOKE.Archive_find__SWIG_1(swigCPtr, pattern, recursive), true);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
