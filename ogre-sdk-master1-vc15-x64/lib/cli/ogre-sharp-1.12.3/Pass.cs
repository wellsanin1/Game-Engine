...
public class Pass : global::System.IDisposable {
  ...
  public bool hasShadowCasterVertexProgram() {
    bool ret = OgrePINVOKE.Pass_hasShadowCasterVertexProgram(swigCPtr);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public bool hasShadowCasterFragmentProgram() {
    bool ret = OgrePINVOKE.Pass_hasShadowCasterFragmentProgram(swigCPtr);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public bool hasShadowReceiverVertexProgram() {
    bool ret = OgrePINVOKE.Pass_hasShadowReceiverVertexProgram(swigCPtr);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public bool hasShadowReceiverFragmentProgram() {
    bool ret = OgrePINVOKE.Pass_hasShadowReceiverFragmentProgram(swigCPtr);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public TextureUnitStates getTextureUnitStates() {
    TextureUnitStates ret = new TextureUnitStates(OgrePINVOKE.Pass_getTextureUnitStates(swigCPtr), false);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public ushort getNumTextureUnitStates() {
    ushort ret = OgrePINVOKE.Pass_getNumTextureUnitStates(swigCPtr);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public void setPolygonModeOverrideable(bool arg0) {
    OgrePINVOKE.Pass_setPolygonModeOverrideable(swigCPtr, arg0);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  public void setShadowCasterVertexProgram(string name) {
    OgrePINVOKE.Pass_setShadowCasterVertexProgram(swigCPtr, name);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public void setShadowCasterVertexProgramParameters(SWIGTYPE_p_Ogre__SharedPtrT_Ogre__GpuProgramParameters_t arg0) {
    OgrePINVOKE.Pass_setShadowCasterVertexProgramParameters(swigCPtr, SWIGTYPE_p_Ogre__SharedPtrT_Ogre__GpuProgramParameters_t.getCPtr(arg0));
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public string getShadowCasterVertexProgramName() {
    string ret = OgrePINVOKE.Pass_getShadowCasterVertexProgramName(swigCPtr);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public SWIGTYPE_p_Ogre__SharedPtrT_Ogre__GpuProgramParameters_t getShadowCasterVertexProgramParameters() {
    SWIGTYPE_p_Ogre__SharedPtrT_Ogre__GpuProgramParameters_t ret = new SWIGTYPE_p_Ogre__SharedPtrT_Ogre__GpuProgramParameters_t(OgrePINVOKE.Pass_getShadowCasterVertexProgramParameters(swigCPtr), true);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public GpuProgramPtr getShadowCasterVertexProgram() {
    GpuProgramPtr ret = new GpuProgramPtr(OgrePINVOKE.Pass_getShadowCasterVertexProgram(swigCPtr), false);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public void setShadowCasterFragmentProgram(string name) {
    OgrePINVOKE.Pass_setShadowCasterFragmentProgram(swigCPtr, name);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public void setShadowCasterFragmentProgramParameters(SWIGTYPE_p_Ogre__SharedPtrT_Ogre__GpuProgramParameters_t arg0) {
    OgrePINVOKE.Pass_setShadowCasterFragmentProgramParameters(swigCPtr, SWIGTYPE_p_Ogre__SharedPtrT_Ogre__GpuProgramParameters_t.getCPtr(arg0));
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public string getShadowCasterFragmentProgramName() {
    string ret = OgrePINVOKE.Pass_getShadowCasterFragmentProgramName(swigCPtr);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public SWIGTYPE_p_Ogre__SharedPtrT_Ogre__GpuProgramParameters_t getShadowCasterFragmentProgramParameters() {
    SWIGTYPE_p_Ogre__SharedPtrT_Ogre__GpuProgramParameters_t ret = new SWIGTYPE_p_Ogre__SharedPtrT_Ogre__GpuProgramParameters_t(OgrePINVOKE.Pass_getShadowCasterFragmentProgramParameters(swigCPtr), true);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public GpuProgramPtr getShadowCasterFragmentProgram() {
    GpuProgramPtr ret = new GpuProgramPtr(OgrePINVOKE.Pass_getShadowCasterFragmentProgram(swigCPtr), false);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public void setShadowReceiverVertexProgram(string name) {
    OgrePINVOKE.Pass_setShadowReceiverVertexProgram(swigCPtr, name);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public void setShadowReceiverVertexProgramParameters(SWIGTYPE_p_Ogre__SharedPtrT_Ogre__GpuProgramParameters_t arg0) {
    OgrePINVOKE.Pass_setShadowReceiverVertexProgramParameters(swigCPtr, SWIGTYPE_p_Ogre__SharedPtrT_Ogre__GpuProgramParameters_t.getCPtr(arg0));
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public void setShadowReceiverFragmentProgram(string name) {
    OgrePINVOKE.Pass_setShadowReceiverFragmentProgram(swigCPtr, name);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public void setShadowReceiverFragmentProgramParameters(SWIGTYPE_p_Ogre__SharedPtrT_Ogre__GpuProgramParameters_t arg0) {
    OgrePINVOKE.Pass_setShadowReceiverFragmentProgramParameters(swigCPtr, SWIGTYPE_p_Ogre__SharedPtrT_Ogre__GpuProgramParameters_t.getCPtr(arg0));
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public string getShadowReceiverVertexProgramName() {
    string ret = OgrePINVOKE.Pass_getShadowReceiverVertexProgramName(swigCPtr);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public SWIGTYPE_p_Ogre__SharedPtrT_Ogre__GpuProgramParameters_t getShadowReceiverVertexProgramParameters() {
    SWIGTYPE_p_Ogre__SharedPtrT_Ogre__GpuProgramParameters_t ret = new SWIGTYPE_p_Ogre__SharedPtrT_Ogre__GpuProgramParameters_t(OgrePINVOKE.Pass_getShadowReceiverVertexProgramParameters(swigCPtr), true);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public GpuProgramPtr getShadowReceiverVertexProgram() {
    GpuProgramPtr ret = new GpuProgramPtr(OgrePINVOKE.Pass_getShadowReceiverVertexProgram(swigCPtr), false);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public string getShadowReceiverFragmentProgramName() {
    string ret = OgrePINVOKE.Pass_getShadowReceiverFragmentProgramName(swigCPtr);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public SWIGTYPE_p_Ogre__SharedPtrT_Ogre__GpuProgramParameters_t getShadowReceiverFragmentProgramParameters() {
    SWIGTYPE_p_Ogre__SharedPtrT_Ogre__GpuProgramParameters_t ret = new SWIGTYPE_p_Ogre__SharedPtrT_Ogre__GpuProgramParameters_t(OgrePINVOKE.Pass_getShadowReceiverFragmentProgramParameters(swigCPtr), true);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public GpuProgramPtr getShadowReceiverFragmentProgram() {
    GpuProgramPtr ret = new GpuProgramPtr(OgrePINVOKE.Pass_getShadowReceiverFragmentProgram(swigCPtr), false);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public void setGpuProgramParameters(GpuProgramType type, SWIGTYPE_p_Ogre__SharedPtrT_Ogre__GpuProgramParameters_t arg1) {
    OgrePINVOKE.Pass_setGpuProgramParameters(swigCPtr, (int)type, SWIGTYPE_p_Ogre__SharedPtrT_Ogre__GpuProgramParameters_t.getCPtr(arg1));
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public void setVertexProgramParameters(SWIGTYPE_p_Ogre__SharedPtrT_Ogre__GpuProgramParameters_t arg0) {
    OgrePINVOKE.Pass_setVertexProgramParameters(swigCPtr, SWIGTYPE_p_Ogre__SharedPtrT_Ogre__GpuProgramParameters_t.getCPtr(arg0));
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public void setFragmentProgramParameters(SWIGTYPE_p_Ogre__SharedPtrT_Ogre__GpuProgramParameters_t arg0) {
    OgrePINVOKE.Pass_setFragmentProgramParameters(swigCPtr, SWIGTYPE_p_Ogre__SharedPtrT_Ogre__GpuProgramParameters_t.getCPtr(arg0));
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public void setGeometryProgramParameters(SWIGTYPE_p_Ogre__SharedPtrT_Ogre__GpuProgramParameters_t arg0) {
    OgrePINVOKE.Pass_setGeometryProgramParameters(swigCPtr, SWIGTYPE_p_Ogre__SharedPtrT_Ogre__GpuProgramParameters_t.getCPtr(arg0));
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public void setTessellationHullProgramParameters(SWIGTYPE_p_Ogre__SharedPtrT_Ogre__GpuProgramParameters_t arg0) {
    OgrePINVOKE.Pass_setTessellationHullProgramParameters(swigCPtr, SWIGTYPE_p_Ogre__SharedPtrT_Ogre__GpuProgramParameters_t.getCPtr(arg0));
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public void setTessellationDomainProgramParameters(SWIGTYPE_p_Ogre__SharedPtrT_Ogre__GpuProgramParameters_t arg0) {
    OgrePINVOKE.Pass_setTessellationDomainProgramParameters(swigCPtr, SWIGTYPE_p_Ogre__SharedPtrT_Ogre__GpuProgramParameters_t.getCPtr(arg0));
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public void setComputeProgramParameters(SWIGTYPE_p_Ogre__SharedPtrT_Ogre__GpuProgramParameters_t arg0) {
    OgrePINVOKE.Pass_setComputeProgramParameters(swigCPtr, SWIGTYPE_p_Ogre__SharedPtrT_Ogre__GpuProgramParameters_t.getCPtr(arg0));
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public SWIGTYPE_p_Ogre__SharedPtrT_Ogre__GpuProgramParameters_t getGpuProgramParameters(GpuProgramType type) {
    SWIGTYPE_p_Ogre__SharedPtrT_Ogre__GpuProgramParameters_t ret = new SWIGTYPE_p_Ogre__SharedPtrT_Ogre__GpuProgramParameters_t(OgrePINVOKE.Pass_getGpuProgramParameters(swigCPtr, (int)type), false);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public SWIGTYPE_p_Ogre__SharedPtrT_Ogre__GpuProgramParameters_t getVertexProgramParameters() {
    SWIGTYPE_p_Ogre__SharedPtrT_Ogre__GpuProgramParameters_t ret = new SWIGTYPE_p_Ogre__SharedPtrT_Ogre__GpuProgramParameters_t(OgrePINVOKE.Pass_getVertexProgramParameters(swigCPtr), true);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public SWIGTYPE_p_Ogre__SharedPtrT_Ogre__GpuProgramParameters_t getFragmentProgramParameters() {
    SWIGTYPE_p_Ogre__SharedPtrT_Ogre__GpuProgramParameters_t ret = new SWIGTYPE_p_Ogre__SharedPtrT_Ogre__GpuProgramParameters_t(OgrePINVOKE.Pass_getFragmentProgramParameters(swigCPtr), true);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public SWIGTYPE_p_Ogre__SharedPtrT_Ogre__GpuProgramParameters_t getGeometryProgramParameters() {
    SWIGTYPE_p_Ogre__SharedPtrT_Ogre__GpuProgramParameters_t ret = new SWIGTYPE_p_Ogre__SharedPtrT_Ogre__GpuProgramParameters_t(OgrePINVOKE.Pass_getGeometryProgramParameters(swigCPtr), true);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public SWIGTYPE_p_Ogre__SharedPtrT_Ogre__GpuProgramParameters_t getTessellationHullProgramParameters() {
    SWIGTYPE_p_Ogre__SharedPtrT_Ogre__GpuProgramParameters_t ret = new SWIGTYPE_p_Ogre__SharedPtrT_Ogre__GpuProgramParameters_t(OgrePINVOKE.Pass_getTessellationHullProgramParameters(swigCPtr), true);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public SWIGTYPE_p_Ogre__SharedPtrT_Ogre__GpuProgramParameters_t getTessellationDomainProgramParameters() {
    SWIGTYPE_p_Ogre__SharedPtrT_Ogre__GpuProgramParameters_t ret = new SWIGTYPE_p_Ogre__SharedPtrT_Ogre__GpuProgramParameters_t(OgrePINVOKE.Pass_getTessellationDomainProgramParameters(swigCPtr), true);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public SWIGTYPE_p_Ogre__SharedPtrT_Ogre__GpuProgramParameters_t getComputeProgramParameters() {
    SWIGTYPE_p_Ogre__SharedPtrT_Ogre__GpuProgramParameters_t ret = new SWIGTYPE_p_Ogre__SharedPtrT_Ogre__GpuProgramParameters_t(OgrePINVOKE.Pass_getComputeProgramParameters(swigCPtr), true);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public void setNormaliseNormals(bool normalise) {
    OgrePINVOKE.Pass_setNormaliseNormals(swigCPtr, normalise);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public bool getNormaliseNormals() {
    bool ret = OgrePINVOKE.Pass_getNormaliseNormals(swigCPtr);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public bool applyTextureAliases(NameValuePairList aliasList, bool apply) {
    bool ret = OgrePINVOKE.Pass_applyTextureAliases__SWIG_0(swigCPtr, NameValuePairList.getCPtr(aliasList), apply);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public bool applyTextureAliases(NameValuePairList aliasList) {
    bool ret = OgrePINVOKE.Pass_applyTextureAliases__SWIG_1(swigCPtr, NameValuePairList.getCPtr(aliasList));
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public void setIlluminationStage(IlluminationStage arg0) {
    OgrePINVOKE.Pass_setIlluminationStage(swigCPtr, (int)arg0);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }
