...
public class Rectangle2D : SimpleRenderable {
  ...
  public Rectangle2D(bool includeTextureCoordinates, HardwareBuffer.Usage vBufUsage) : this(OgrePINVOKE.new_Rectangle2D__SWIG_0(includeTextureCoordinates, (int)vBufUsage), true) {
  ...
  public Rectangle2D(string name, bool includeTextureCoordinates, HardwareBuffer.Usage vBufUsage) : this(OgrePINVOKE.new_Rectangle2D__SWIG_3(name, includeTextureCoordinates, (int)vBufUsage), true) {
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }
