...
public class Billboard : global::System.IDisposable {
  ...
  public BillboardSet mParentSet {
    set {
      OgrePINVOKE.Billboard_mParentSet_set(swigCPtr, BillboardSet.getCPtr(value));
      if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    } 
    get {
      global::System.IntPtr cPtr = OgrePINVOKE.Billboard_mParentSet_get(swigCPtr);
  ...
  public ColourValue mColour {
    set {
      OgrePINVOKE.Billboard_mColour_set(swigCPtr, ColourValue.getCPtr(value));
      if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    } 
    get {
      global::System.IntPtr cPtr = OgrePINVOKE.Billboard_mColour_get(swigCPtr);
  ...
  public ColourValue getColour() {
    ColourValue ret = new ColourValue(OgrePINVOKE.Billboard_getColour(swigCPtr), false);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
