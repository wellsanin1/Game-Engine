...
public class RenderSystemCapabilities : global::System.IDisposable {
  ...
  public void setNumVertexBlendMatrices(ushort num) {
    OgrePINVOKE.RenderSystemCapabilities_setNumVertexBlendMatrices(swigCPtr, num);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  public ushort getNumVertexBlendMatrices() {
    ushort ret = OgrePINVOKE.RenderSystemCapabilities_getNumVertexBlendMatrices(swigCPtr);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public ushort getVertexProgramConstantFloatCount() {
    ushort ret = OgrePINVOKE.RenderSystemCapabilities_getVertexProgramConstantFloatCount(swigCPtr);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public ushort getVertexProgramConstantIntCount() {
    ushort ret = OgrePINVOKE.RenderSystemCapabilities_getVertexProgramConstantIntCount(swigCPtr);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public ushort getVertexProgramConstantBoolCount() {
    ushort ret = OgrePINVOKE.RenderSystemCapabilities_getVertexProgramConstantBoolCount(swigCPtr);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public ushort getGeometryProgramConstantFloatCount() {
    ushort ret = OgrePINVOKE.RenderSystemCapabilities_getGeometryProgramConstantFloatCount(swigCPtr);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public ushort getGeometryProgramConstantIntCount() {
    ushort ret = OgrePINVOKE.RenderSystemCapabilities_getGeometryProgramConstantIntCount(swigCPtr);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public ushort getGeometryProgramConstantBoolCount() {
    ushort ret = OgrePINVOKE.RenderSystemCapabilities_getGeometryProgramConstantBoolCount(swigCPtr);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public ushort getFragmentProgramConstantFloatCount() {
    ushort ret = OgrePINVOKE.RenderSystemCapabilities_getFragmentProgramConstantFloatCount(swigCPtr);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public ushort getFragmentProgramConstantIntCount() {
    ushort ret = OgrePINVOKE.RenderSystemCapabilities_getFragmentProgramConstantIntCount(swigCPtr);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public ushort getFragmentProgramConstantBoolCount() {
    ushort ret = OgrePINVOKE.RenderSystemCapabilities_getFragmentProgramConstantBoolCount(swigCPtr);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public void setVertexProgramConstantIntCount(ushort c) {
    OgrePINVOKE.RenderSystemCapabilities_setVertexProgramConstantIntCount(swigCPtr, c);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public void setVertexProgramConstantBoolCount(ushort c) {
    OgrePINVOKE.RenderSystemCapabilities_setVertexProgramConstantBoolCount(swigCPtr, c);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  public void setGeometryProgramConstantIntCount(ushort c) {
    OgrePINVOKE.RenderSystemCapabilities_setGeometryProgramConstantIntCount(swigCPtr, c);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public void setGeometryProgramConstantBoolCount(ushort c) {
    OgrePINVOKE.RenderSystemCapabilities_setGeometryProgramConstantBoolCount(swigCPtr, c);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  public void setFragmentProgramConstantIntCount(ushort c) {
    OgrePINVOKE.RenderSystemCapabilities_setFragmentProgramConstantIntCount(swigCPtr, c);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public void setFragmentProgramConstantBoolCount(ushort c) {
    OgrePINVOKE.RenderSystemCapabilities_setFragmentProgramConstantBoolCount(swigCPtr, c);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  public void setVertexTextureUnitsShared(bool shared) {
    OgrePINVOKE.RenderSystemCapabilities_setVertexTextureUnitsShared(swigCPtr, shared);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public bool getVertexTextureUnitsShared() {
    bool ret = OgrePINVOKE.RenderSystemCapabilities_getVertexTextureUnitsShared(swigCPtr);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public void setTessellationHullProgramConstantIntCount(ushort c) {
    OgrePINVOKE.RenderSystemCapabilities_setTessellationHullProgramConstantIntCount(swigCPtr, c);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public void setTessellationHullProgramConstantBoolCount(ushort c) {
    OgrePINVOKE.RenderSystemCapabilities_setTessellationHullProgramConstantBoolCount(swigCPtr, c);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public ushort getTessellationHullProgramConstantFloatCount() {
    ushort ret = OgrePINVOKE.RenderSystemCapabilities_getTessellationHullProgramConstantFloatCount(swigCPtr);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public ushort getTessellationHullProgramConstantIntCount() {
    ushort ret = OgrePINVOKE.RenderSystemCapabilities_getTessellationHullProgramConstantIntCount(swigCPtr);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public ushort getTessellationHullProgramConstantBoolCount() {
    ushort ret = OgrePINVOKE.RenderSystemCapabilities_getTessellationHullProgramConstantBoolCount(swigCPtr);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public void setTessellationDomainProgramConstantIntCount(ushort c) {
    OgrePINVOKE.RenderSystemCapabilities_setTessellationDomainProgramConstantIntCount(swigCPtr, c);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public void setTessellationDomainProgramConstantBoolCount(ushort c) {
    OgrePINVOKE.RenderSystemCapabilities_setTessellationDomainProgramConstantBoolCount(swigCPtr, c);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public ushort getTessellationDomainProgramConstantFloatCount() {
    ushort ret = OgrePINVOKE.RenderSystemCapabilities_getTessellationDomainProgramConstantFloatCount(swigCPtr);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public ushort getTessellationDomainProgramConstantIntCount() {
    ushort ret = OgrePINVOKE.RenderSystemCapabilities_getTessellationDomainProgramConstantIntCount(swigCPtr);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public ushort getTessellationDomainProgramConstantBoolCount() {
    ushort ret = OgrePINVOKE.RenderSystemCapabilities_getTessellationDomainProgramConstantBoolCount(swigCPtr);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public void setComputeProgramConstantIntCount(ushort c) {
    OgrePINVOKE.RenderSystemCapabilities_setComputeProgramConstantIntCount(swigCPtr, c);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public void setComputeProgramConstantBoolCount(ushort c) {
    OgrePINVOKE.RenderSystemCapabilities_setComputeProgramConstantBoolCount(swigCPtr, c);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public ushort getComputeProgramConstantFloatCount() {
    ushort ret = OgrePINVOKE.RenderSystemCapabilities_getComputeProgramConstantFloatCount(swigCPtr);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public ushort getComputeProgramConstantIntCount() {
    ushort ret = OgrePINVOKE.RenderSystemCapabilities_getComputeProgramConstantIntCount(swigCPtr);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public ushort getComputeProgramConstantBoolCount() {
    ushort ret = OgrePINVOKE.RenderSystemCapabilities_getComputeProgramConstantBoolCount(swigCPtr);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
