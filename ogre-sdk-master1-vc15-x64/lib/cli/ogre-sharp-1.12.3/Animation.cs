...
public class Animation : global::System.IDisposable {
  ...
  public void apply(Skeleton skeleton, float timePos, float weight, SWIGTYPE_p_std__vectorT_float_t blendMask, float scale) {
    OgrePINVOKE.Animation_apply__SWIG_6(swigCPtr, Skeleton.getCPtr(skeleton), timePos, weight, SWIGTYPE_p_std__vectorT_float_t.getCPtr(blendMask), scale);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  public SWIGTYPE_p_Ogre__ConstMapIteratorT_std__mapT_unsigned_short_Ogre__NumericAnimationTrack_p_std__lessT_unsigned_short_t_t_t getNumericTrackIterator() {
    SWIGTYPE_p_Ogre__ConstMapIteratorT_std__mapT_unsigned_short_Ogre__NumericAnimationTrack_p_std__lessT_unsigned_short_t_t_t ret = new SWIGTYPE_p_Ogre__ConstMapIteratorT_std__mapT_unsigned_short_Ogre__NumericAnimationTrack_p_std__lessT_unsigned_short_t_t_t(OgrePINVOKE.Animation_getNumericTrackIterator(swigCPtr), true);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public SWIGTYPE_p_Ogre__ConstMapIteratorT_std__mapT_unsigned_short_Ogre__VertexAnimationTrack_p_std__lessT_unsigned_short_t_t_t getVertexTrackIterator() {
    SWIGTYPE_p_Ogre__ConstMapIteratorT_std__mapT_unsigned_short_Ogre__VertexAnimationTrack_p_std__lessT_unsigned_short_t_t_t ret = new SWIGTYPE_p_Ogre__ConstMapIteratorT_std__mapT_unsigned_short_Ogre__VertexAnimationTrack_p_std__lessT_unsigned_short_t_t_t(OgrePINVOKE.Animation_getVertexTrackIterator(swigCPtr), true);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
