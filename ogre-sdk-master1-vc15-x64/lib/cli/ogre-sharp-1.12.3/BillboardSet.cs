...
public class BillboardSet : MovableObject {
  ...
  public virtual void setPoolSize(uint size) {
  ...
  public virtual void _notifyBillboardResized() {
    OgrePINVOKE.BillboardSet__notifyBillboardResized(swigCPtr);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public virtual void _notifyBillboardRotated() {
    OgrePINVOKE.BillboardSet__notifyBillboardRotated(swigCPtr);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  public SWIGTYPE_p_Ogre__HashedVectorT_Ogre__Light_p_t getLights() {
    SWIGTYPE_p_Ogre__HashedVectorT_Ogre__Light_p_t ret = new SWIGTYPE_p_Ogre__HashedVectorT_Ogre__Light_p_t(OgrePINVOKE.BillboardSet_getLights(swigCPtr), false);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public virtual void setTextureCoords(FloatRect coords, ushort numCoords) {
    OgrePINVOKE.BillboardSet_setTextureCoords(swigCPtr, FloatRect.getCPtr(coords), numCoords);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }
