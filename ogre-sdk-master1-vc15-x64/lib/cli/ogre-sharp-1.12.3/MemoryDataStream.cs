...
public class MemoryDataStream : DataStream {
  ...
  public MemoryDataStream(SWIGTYPE_p_void pMem, uint size, bool freeOnClose, bool readOnly) : this(OgrePINVOKE.new_MemoryDataStream__SWIG_0(SWIGTYPE_p_void.getCPtr(pMem), size, freeOnClose, readOnly), true) {
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public MemoryDataStream(SWIGTYPE_p_void pMem, uint size, bool freeOnClose) : this(OgrePINVOKE.new_MemoryDataStream__SWIG_1(SWIGTYPE_p_void.getCPtr(pMem), size, freeOnClose), true) {
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public MemoryDataStream(SWIGTYPE_p_void pMem, uint size) : this(OgrePINVOKE.new_MemoryDataStream__SWIG_2(SWIGTYPE_p_void.getCPtr(pMem), size), true) {
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public MemoryDataStream(string name, SWIGTYPE_p_void pMem, uint size, bool freeOnClose, bool readOnly) : this(OgrePINVOKE.new_MemoryDataStream__SWIG_3(name, SWIGTYPE_p_void.getCPtr(pMem), size, freeOnClose, readOnly), true) {
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public MemoryDataStream(string name, SWIGTYPE_p_void pMem, uint size, bool freeOnClose) : this(OgrePINVOKE.new_MemoryDataStream__SWIG_4(name, SWIGTYPE_p_void.getCPtr(pMem), size, freeOnClose), true) {
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public MemoryDataStream(string name, SWIGTYPE_p_void pMem, uint size) : this(OgrePINVOKE.new_MemoryDataStream__SWIG_5(name, SWIGTYPE_p_void.getCPtr(pMem), size), true) {
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  public override uint read(SWIGTYPE_p_void buf, uint count) {
    uint ret = OgrePINVOKE.MemoryDataStream_read(swigCPtr, SWIGTYPE_p_void.getCPtr(buf), count);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public override uint write(SWIGTYPE_p_void buf, uint count) {
    uint ret = OgrePINVOKE.MemoryDataStream_write(swigCPtr, SWIGTYPE_p_void.getCPtr(buf), count);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
