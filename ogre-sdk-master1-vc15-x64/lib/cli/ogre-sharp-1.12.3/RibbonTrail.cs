...
public class RibbonTrail : BillboardChain {
  ...
  public virtual SWIGTYPE_p_Ogre__ConstVectorIteratorT_std__vectorT_Ogre__Node_p_t_t getNodeIterator() {
    SWIGTYPE_p_Ogre__ConstVectorIteratorT_std__vectorT_Ogre__Node_p_t_t ret = new SWIGTYPE_p_Ogre__ConstVectorIteratorT_std__vectorT_Ogre__Node_p_t_t(OgrePINVOKE.RibbonTrail_getNodeIterator(swigCPtr), true);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public virtual void setTrailLength(float len) {
    OgrePINVOKE.RibbonTrail_setTrailLength(swigCPtr, len);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public virtual float getTrailLength() {
  ...
  public virtual ColourValue getInitialColour(uint chainIndex) {
  ...
  public virtual float getInitialWidth(uint chainIndex) {
  ...
  public virtual float getWidthChange(uint chainIndex) {
  ...
  public virtual ColourValue getColourChange(uint chainIndex) {
