...
public class GpuSharedParameters : global::System.IDisposable {
  ...
  public uint getFrameLastUpdated() {
    uint ret = OgrePINVOKE.GpuSharedParameters_getFrameLastUpdated(swigCPtr);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public void setNamedConstant(string name, float val) {
    OgrePINVOKE.GpuSharedParameters_setNamedConstant__SWIG_0(swigCPtr, name, val);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public void setNamedConstant(string name, int val) {
    OgrePINVOKE.GpuSharedParameters_setNamedConstant__SWIG_1(swigCPtr, name, val);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public void setNamedConstant(string name, uint val) {
    OgrePINVOKE.GpuSharedParameters_setNamedConstant__SWIG_2(swigCPtr, name, val);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public void setNamedConstant(string name, Vector4 vec) {
    OgrePINVOKE.GpuSharedParameters_setNamedConstant__SWIG_3(swigCPtr, name, Vector4.getCPtr(vec));
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public void setNamedConstant(string name, Vector3 vec) {
    OgrePINVOKE.GpuSharedParameters_setNamedConstant__SWIG_4(swigCPtr, name, Vector3.getCPtr(vec));
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public void setNamedConstant(string name, Vector2 vec) {
    OgrePINVOKE.GpuSharedParameters_setNamedConstant__SWIG_5(swigCPtr, name, Vector2.getCPtr(vec));
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public void setNamedConstant(string name, Matrix4 m) {
    OgrePINVOKE.GpuSharedParameters_setNamedConstant__SWIG_6(swigCPtr, name, Matrix4.getCPtr(m));
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public void setNamedConstant(string name, Matrix4 m, uint numEntries) {
    OgrePINVOKE.GpuSharedParameters_setNamedConstant__SWIG_7(swigCPtr, name, Matrix4.getCPtr(m), numEntries);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  public void setNamedConstant(string name, SWIGTYPE_p_double val, uint count) {
    OgrePINVOKE.GpuSharedParameters_setNamedConstant__SWIG_9(swigCPtr, name, SWIGTYPE_p_double.getCPtr(val), count);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  public SWIGTYPE_p_std__vectorT_float_t getFloatConstantList() {
    SWIGTYPE_p_std__vectorT_float_t ret = new SWIGTYPE_p_std__vectorT_float_t(OgrePINVOKE.GpuSharedParameters_getFloatConstantList(swigCPtr), false);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public SWIGTYPE_p_std__vectorT_double_t getDoubleConstantList() {
    SWIGTYPE_p_std__vectorT_double_t ret = new SWIGTYPE_p_std__vectorT_double_t(OgrePINVOKE.GpuSharedParameters_getDoubleConstantList(swigCPtr), false);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public void _setRenderSystemData(Any data) {
    OgrePINVOKE.GpuSharedParameters__setRenderSystemData(swigCPtr, Any.getCPtr(data));
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public Any _getRenderSystemData() {
    Any ret = new Any(OgrePINVOKE.GpuSharedParameters__getRenderSystemData(swigCPtr), false);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
