...
public class RenderWindow : RenderTarget {
  ...
  public virtual void create(string name, uint widthPt, uint heightPt, bool fullScreen, NameValuePairList miscParams) {
    OgrePINVOKE.RenderWindow_create(swigCPtr, name, widthPt, heightPt, fullScreen, NameValuePairList.getCPtr(miscParams));
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  public virtual void getMetrics(SWIGTYPE_p_unsigned_int width, SWIGTYPE_p_unsigned_int height, SWIGTYPE_p_unsigned_int colourDepth, SWIGTYPE_p_int left, SWIGTYPE_p_int top) {
    OgrePINVOKE.RenderWindow_getMetrics__SWIG_0(swigCPtr, SWIGTYPE_p_unsigned_int.getCPtr(width), SWIGTYPE_p_unsigned_int.getCPtr(height), SWIGTYPE_p_unsigned_int.getCPtr(colourDepth), SWIGTYPE_p_int.getCPtr(left), SWIGTYPE_p_int.getCPtr(top));
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public override void getMetrics(SWIGTYPE_p_unsigned_int width, SWIGTYPE_p_unsigned_int height, SWIGTYPE_p_unsigned_int colourDepth) {
    OgrePINVOKE.RenderWindow_getMetrics__SWIG_1_0(swigCPtr, SWIGTYPE_p_unsigned_int.getCPtr(width), SWIGTYPE_p_unsigned_int.getCPtr(height), SWIGTYPE_p_unsigned_int.getCPtr(colourDepth));
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }
