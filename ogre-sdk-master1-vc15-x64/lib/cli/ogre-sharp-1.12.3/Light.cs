...
public class Light : MovableObject {
  ...
  public void setDirection(float x, float y, float z) {
    OgrePINVOKE.Light_setDirection__SWIG_0(swigCPtr, x, y, z);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public void setDirection(Vector3 vec) {
    OgrePINVOKE.Light_setDirection__SWIG_1(swigCPtr, Vector3.getCPtr(vec));
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  public void _notifyAttached(Node parent, bool isTagPoint) {
    OgrePINVOKE.Light__notifyAttached__SWIG_0(swigCPtr, Node.getCPtr(parent), isTagPoint);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public void _notifyAttached(Node parent) {
    OgrePINVOKE.Light__notifyAttached__SWIG_1(swigCPtr, Node.getCPtr(parent));
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public override void _notifyMoved() {
    OgrePINVOKE.Light__notifyMoved(swigCPtr);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  public Vector3 getDerivedPosition(bool cameraRelativeIfSet) {
    Vector3 ret = new Vector3(OgrePINVOKE.Light_getDerivedPosition__SWIG_0(swigCPtr, cameraRelativeIfSet), false);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public Vector3 getDerivedPosition() {
    Vector3 ret = new Vector3(OgrePINVOKE.Light_getDerivedPosition__SWIG_1(swigCPtr), false);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public Vector3 getDerivedDirection() {
    Vector3 ret = new Vector3(OgrePINVOKE.Light_getDerivedDirection(swigCPtr), false);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public float _deriveShadowFarClipDistance(Camera maincam) {
    float ret = OgrePINVOKE.Light__deriveShadowFarClipDistance(swigCPtr, Camera.getCPtr(maincam));
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
