...
public class Skeleton : Resource {
  ...
  public Skeleton(ResourceManager creator, string name, ulong handle, string group, bool isManual, ManualResourceLoader loader) : this(OgrePINVOKE.new_Skeleton__SWIG_1(ResourceManager.getCPtr(creator), name, handle, group, isManual, ManualResourceLoader.getCPtr(loader)), true) {
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public Skeleton(ResourceManager creator, string name, ulong handle, string group, bool isManual) : this(OgrePINVOKE.new_Skeleton__SWIG_2(ResourceManager.getCPtr(creator), name, handle, group, isManual), true) {
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public Skeleton(ResourceManager creator, string name, ulong handle, string group) : this(OgrePINVOKE.new_Skeleton__SWIG_3(ResourceManager.getCPtr(creator), name, handle, group), true) {
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  public virtual SWIGTYPE_p_Ogre__ConstVectorIteratorT_std__vectorT_Ogre__LinkedSkeletonAnimationSource_t_t getLinkedSkeletonAnimationSourceIterator() {
    SWIGTYPE_p_Ogre__ConstVectorIteratorT_std__vectorT_Ogre__LinkedSkeletonAnimationSource_t_t ret = new SWIGTYPE_p_Ogre__ConstVectorIteratorT_std__vectorT_Ogre__LinkedSkeletonAnimationSource_t_t(OgrePINVOKE.Skeleton_getLinkedSkeletonAnimationSourceIterator(swigCPtr), true);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public virtual void _mergeSkeletonAnimations(Skeleton source, SWIGTYPE_p_std__vectorT_unsigned_short_t boneHandleMap, StringVector animations) {
    OgrePINVOKE.Skeleton__mergeSkeletonAnimations__SWIG_0(swigCPtr, Skeleton.getCPtr(source), SWIGTYPE_p_std__vectorT_unsigned_short_t.getCPtr(boneHandleMap), StringVector.getCPtr(animations));
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }
