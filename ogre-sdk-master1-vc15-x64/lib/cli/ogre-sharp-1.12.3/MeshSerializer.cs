...
public class MeshSerializer : Serializer {
  ...
  public void exportMesh(Mesh pMesh, string filename, Serializer.Endian endianMode) {
    OgrePINVOKE.MeshSerializer_exportMesh__SWIG_0(swigCPtr, Mesh.getCPtr(pMesh), filename, (int)endianMode);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }

  public void exportMesh(Mesh pMesh, string filename) {
    OgrePINVOKE.MeshSerializer_exportMesh__SWIG_1(swigCPtr, Mesh.getCPtr(pMesh), filename);
    if (OgrePINVOKE.SWIGPendingException.Pending) throw OgrePINVOKE.SWIGPendingException.Retrieve();
  }
