...
public class TextAreaOverlayElement : OverlayElement {
  ...
  internal TextAreaOverlayElement(global::System.IntPtr cPtr, bool cMemoryOwn) : base(OgreOverlayPINVOKE.TextAreaOverlayElement_SWIGSmartPtrUpcast(cPtr), true) {
  ...
  public override void setCaption(SWIGTYPE_p_UTFString text) {
    OgreOverlayPINVOKE.TextAreaOverlayElement_setCaption(swigCPtr, SWIGTYPE_p_UTFString.getCPtr(text));
    if (OgreOverlayPINVOKE.SWIGPendingException.Pending) throw OgreOverlayPINVOKE.SWIGPendingException.Retrieve();
  }
